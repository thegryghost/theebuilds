...
SRC_URI="https://github.com/pineappleEA/pineapple-src/archive/refs/tags/EA-${PV}.tar.gz -> ${P}.tar.gz
...
src_install() {
	...
	mv "${D}/usr/bin/yuzu" "${D}/usr/bin/yuzu-ea-pineapple"
	mv "${D}/usr/bin/yuzu-cmd" "${D}/usr/bin/yuzu-cmd-ea-pineapple"
	mv "${D}/usr/share/applications/yuzu.desktop" "${D}/usr/share/applications/yuzu-ea-pineapple.desktop"
	mv "${D}/usr/share/icons/hicolor/scalable/apps/yuzu.svg" "${D}/usr/share/icons/hicolor/scalable/apps/yuzu-ea-pineapple.svg"
	mv "${D}/usr/share/mime/packages/yuzu.xml" "${D}/usr/share/mime/packages/yuzu-ea-pineapple.xml"
}
