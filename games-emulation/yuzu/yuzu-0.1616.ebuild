...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1616/11535.diff"
		eapply "${FILESDIR}/0.1616/11792.diff"
		eapply "${FILESDIR}/0.1616/11912.diff"
		eapply "${FILESDIR}/0.1616/11914.diff"
		eapply "${FILESDIR}/0.1616/11917.diff"
		eapply "${FILESDIR}/0.1616/4042.diff"
	fi
