...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1704/12173.diff"
		eapply "${FILESDIR}/0.1704/12461.diff"
		eapply "${FILESDIR}/0.1704/12749.diff"
		eapply "${FILESDIR}/0.1704/12756.diff"
		eapply "${FILESDIR}/0.1704/12873.diff"
		eapply "${FILESDIR}/0.1704/12883.diff"
		eapply "${FILESDIR}/0.1704/12905.diff"
		eapply "${FILESDIR}/0.1704/12914.diff"
		eapply "${FILESDIR}/0.1704/12915.diff"
		eapply "${FILESDIR}/0.1704/12916.diff"
		eapply "${FILESDIR}/0.1704/4042.diff"
	fi
