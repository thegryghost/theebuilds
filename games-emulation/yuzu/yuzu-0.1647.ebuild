...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1647/11623.diff"
		eapply "${FILESDIR}/0.1647/12184.diff"
		eapply "${FILESDIR}/0.1647/12304.diff"
		eapply "${FILESDIR}/0.1647/12317.diff"
		eapply "${FILESDIR}/0.1647/12321.diff"
		eapply "${FILESDIR}/0.1647/12322.diff"
		eapply "${FILESDIR}/0.1647/4042.diff"
	fi
