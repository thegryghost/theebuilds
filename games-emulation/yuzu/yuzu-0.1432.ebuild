...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1432/10086.diff"
		eapply "${FILESDIR}/0.1432/10091.diff"
		eapply "${FILESDIR}/0.1432/10107.diff"
		eapply "${FILESDIR}/0.1432/10181.diff"
		eapply "${FILESDIR}/0.1432/10221.diff"
		eapply "${FILESDIR}/0.1432/10234.diff"
		eapply "${FILESDIR}/0.1432/10249.diff"
		eapply "${FILESDIR}/0.1432/10254.diff"
		eapply "${FILESDIR}/0.1432/10262.diff"
		eapply "${FILESDIR}/0.1432/10265.diff"
		eapply "${FILESDIR}/0.1432/10288.diff"
		eapply "${FILESDIR}/0.1432/4042.diff"
	fi
