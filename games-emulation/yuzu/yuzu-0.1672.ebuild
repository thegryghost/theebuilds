...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1672/12173.diff"
		eapply "${FILESDIR}/0.1672/12437.diff"
		eapply "${FILESDIR}/0.1672/12549.diff"
		eapply "${FILESDIR}/0.1672/12557.diff"
		eapply "${FILESDIR}/0.1672/4042.diff"
	fi
