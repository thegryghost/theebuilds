...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1394/10008.diff"
		eapply "${FILESDIR}/0.1394/10009.diff"
		eapply "${FILESDIR}/0.1394/10014.diff"
		eapply "${FILESDIR}/0.1394/10027.diff"
		eapply "${FILESDIR}/0.1394/10030.diff"
		eapply "${FILESDIR}/0.1394/4042.diff"
	fi
