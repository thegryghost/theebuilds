...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1651/11623.diff"
		eapply "${FILESDIR}/0.1651/12184.diff"
		eapply "${FILESDIR}/0.1651/12290.diff"
		eapply "${FILESDIR}/0.1651/12304.diff"
		eapply "${FILESDIR}/0.1651/12344.diff"
		eapply "${FILESDIR}/0.1651/12345.diff"
		eapply "${FILESDIR}/0.1651/12349.diff"
		eapply "${FILESDIR}/0.1651/12359.diff"
		eapply "${FILESDIR}/0.1651/4042.diff"
	fi
