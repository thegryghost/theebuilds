...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1630/11535.diff"
		eapply "${FILESDIR}/0.1630/11623.diff"
		eapply "${FILESDIR}/0.1630/11889.diff"
		eapply "${FILESDIR}/0.1630/12076.diff"
		eapply "${FILESDIR}/0.1630/12098.diff"
		eapply "${FILESDIR}/0.1630/4042.diff"
	fi
