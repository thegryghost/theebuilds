...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1609/11535.diff"
		eapply "${FILESDIR}/0.1609/11873.diff"
		eapply "${FILESDIR}/0.1609/11881.diff"
		eapply "${FILESDIR}/0.1609/11885.diff"
		eapply "${FILESDIR}/0.1609/11894.diff"
		eapply "${FILESDIR}/0.1609/11896.diff"
		eapply "${FILESDIR}/0.1609/11912.diff"
		eapply "${FILESDIR}/0.1609/11914.diff"
		eapply "${FILESDIR}/0.1609/11917.diff"
		eapply "${FILESDIR}/0.1609/4042.diff"
	fi
