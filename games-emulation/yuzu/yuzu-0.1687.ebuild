...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1687/12173.diff"
		eapply "${FILESDIR}/0.1687/12579.diff"
		eapply "${FILESDIR}/0.1687/12660.diff"
		eapply "${FILESDIR}/0.1687/12688.diff"
		eapply "${FILESDIR}/0.1687/12701.diff"
		eapply "${FILESDIR}/0.1687/4042.diff"
	fi
