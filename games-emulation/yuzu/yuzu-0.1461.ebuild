...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1461/10086.diff"
		eapply "${FILESDIR}/0.1461/10389.diff"
		eapply "${FILESDIR}/0.1461/10476.diff"
		eapply "${FILESDIR}/0.1461/10583.diff"
		eapply "${FILESDIR}/0.1461/10591.diff"
		eapply "${FILESDIR}/0.1461/4042.diff"
	fi
