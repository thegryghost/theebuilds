...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1645/11623.diff"
		eapply "${FILESDIR}/0.1645/12173.diff"
		eapply "${FILESDIR}/0.1645/12208.diff"
		eapply "${FILESDIR}/0.1645/12274.diff"
		eapply "${FILESDIR}/0.1645/12289.diff"
		eapply "${FILESDIR}/0.1645/4042.diff"
	fi
