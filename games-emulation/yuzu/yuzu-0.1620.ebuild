...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1620/11535.diff"
		eapply "${FILESDIR}/0.1620/11623.diff"
		eapply "${FILESDIR}/0.1620/11792.diff"
		eapply "${FILESDIR}/0.1620/11995.diff"
		eapply "${FILESDIR}/0.1620/12019.diff"
		eapply "${FILESDIR}/0.1620/4042.diff"
	fi
