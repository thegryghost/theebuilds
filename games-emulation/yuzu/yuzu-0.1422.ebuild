...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1422/10081.diff"
		eapply "${FILESDIR}/0.1422/10086.diff"
		eapply "${FILESDIR}/0.1422/10155.diff"
		eapply "${FILESDIR}/0.1422/10165.diff"
		eapply "${FILESDIR}/0.1422/4042.diff"
	fi
