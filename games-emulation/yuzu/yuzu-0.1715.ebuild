...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1715/10529.diff"
		eapply "${FILESDIR}/0.1715/12173.diff"
		eapply "${FILESDIR}/0.1715/12461.diff"
		eapply "${FILESDIR}/0.1715/12749.diff"
		eapply "${FILESDIR}/0.1715/12873.diff"
		eapply "${FILESDIR}/0.1715/13000.diff"
		eapply "${FILESDIR}/0.1715/13011.diff"
		eapply "${FILESDIR}/0.1715/13016.diff"
		eapply "${FILESDIR}/0.1715/4042.diff"
	fi
