...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1588/11349.diff"
		eapply "${FILESDIR}/0.1588/11535.diff"
		eapply "${FILESDIR}/0.1588/11653.diff"
		eapply "${FILESDIR}/0.1588/11747.diff"
		eapply "${FILESDIR}/0.1588/11748.diff"
		eapply "${FILESDIR}/0.1588/11774.diff"
		eapply "${FILESDIR}/0.1588/4042.diff"
	fi
