...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1593/11535.diff"
		eapply "${FILESDIR}/0.1593/11689.diff"
		eapply "${FILESDIR}/0.1593/11748.diff"
		eapply "${FILESDIR}/0.1593/11806.diff"
		eapply "${FILESDIR}/0.1593/4042.diff"
	fi
