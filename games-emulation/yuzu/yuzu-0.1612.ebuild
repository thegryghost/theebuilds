...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1612/11535.diff"
		eapply "${FILESDIR}/0.1612/11873.diff"
		eapply "${FILESDIR}/0.1612/11896.diff"
		eapply "${FILESDIR}/0.1612/11912.diff"
		eapply "${FILESDIR}/0.1612/11914.diff"
		eapply "${FILESDIR}/0.1612/11917.diff"
		eapply "${FILESDIR}/0.1612/4042.diff"
	fi
