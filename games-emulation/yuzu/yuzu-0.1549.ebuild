...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1549/10519.diff"
		eapply "${FILESDIR}/0.1549/11225.diff"
		eapply "${FILESDIR}/0.1549/11385.diff"
		eapply "${FILESDIR}/0.1549/11402.diff"
		eapply "${FILESDIR}/0.1549/11435.diff"
		eapply "${FILESDIR}/0.1549/11436.diff"
		eapply "${FILESDIR}/0.1549/11450.diff"
		eapply "${FILESDIR}/0.1549/4042.diff"
	fi
