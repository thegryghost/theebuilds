...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1393/10008.diff"
		eapply "${FILESDIR}/0.1393/10009.diff"
		eapply "${FILESDIR}/0.1393/10014.diff"
		eapply "${FILESDIR}/0.1393/10027.diff"
		eapply "${FILESDIR}/0.1393/4042.diff"
	fi
