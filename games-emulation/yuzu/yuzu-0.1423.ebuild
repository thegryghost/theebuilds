...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1423/10081.diff"
		eapply "${FILESDIR}/0.1423/10086.diff"
		eapply "${FILESDIR}/0.1423/10155.diff"
		eapply "${FILESDIR}/0.1423/10172.diff"
		eapply "${FILESDIR}/0.1423/4042.diff"
	fi
