...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1469/10086.diff"
		eapply "${FILESDIR}/0.1469/10389.diff"
		eapply "${FILESDIR}/0.1469/10457.diff"
		eapply "${FILESDIR}/0.1469/10486.diff"
		eapply "${FILESDIR}/0.1469/10729.diff"
		eapply "${FILESDIR}/0.1469/10731.diff"
		eapply "${FILESDIR}/0.1469/10739.diff"
		eapply "${FILESDIR}/0.1469/10744.diff"
		eapply "${FILESDIR}/0.1469/4042.diff"
	fi
