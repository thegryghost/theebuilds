...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1635/11623.diff"
		eapply "${FILESDIR}/0.1635/11902.diff"
		eapply "${FILESDIR}/0.1635/12154.diff"
		eapply "${FILESDIR}/0.1635/12173.diff"
		eapply "${FILESDIR}/0.1635/12201.diff"
		eapply "${FILESDIR}/0.1635/12203.diff"
		eapply "${FILESDIR}/0.1635/4042.diff"
	fi
