...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1709/12173.diff"
		eapply "${FILESDIR}/0.1709/12461.diff"
		eapply "${FILESDIR}/0.1709/12749.diff"
		eapply "${FILESDIR}/0.1709/12756.diff"
		eapply "${FILESDIR}/0.1709/12949.diff"
		eapply "${FILESDIR}/0.1709/12955.diff"
		eapply "${FILESDIR}/0.1709/12969.diff"
		eapply "${FILESDIR}/0.1709/4042.diff"
	fi
