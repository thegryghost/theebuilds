...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1685/12173.diff"
		eapply "${FILESDIR}/0.1685/12579.diff"
		eapply "${FILESDIR}/0.1685/12644.diff"
		eapply "${FILESDIR}/0.1685/12688.diff"
		eapply "${FILESDIR}/0.1685/4042.diff"
	fi
