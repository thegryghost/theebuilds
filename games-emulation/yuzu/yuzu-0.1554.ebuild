...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1554/10519.diff"
		eapply "${FILESDIR}/0.1554/11225.diff"
		eapply "${FILESDIR}/0.1554/11385.diff"
		eapply "${FILESDIR}/0.1554/11402.diff"
		eapply "${FILESDIR}/0.1554/11435.diff"
		eapply "${FILESDIR}/0.1554/11436.diff"
		eapply "${FILESDIR}/0.1554/11450.diff"
		eapply "${FILESDIR}/0.1554/11456.diff"
		eapply "${FILESDIR}/0.1554/11459.diff"
		eapply "${FILESDIR}/0.1554/11465.diff"
		eapply "${FILESDIR}/0.1554/11467.diff"
		eapply "${FILESDIR}/0.1554/4042.diff"
	fi
