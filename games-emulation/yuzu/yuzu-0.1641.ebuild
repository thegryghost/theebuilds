...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1641/11623.diff"
		eapply "${FILESDIR}/0.1641/12173.diff"
		eapply "${FILESDIR}/0.1641/12208.diff"
		eapply "${FILESDIR}/0.1641/12236.diff"
		eapply "${FILESDIR}/0.1641/12274.diff"
		eapply "${FILESDIR}/0.1641/4042.diff"
	fi
