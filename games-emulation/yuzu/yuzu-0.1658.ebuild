...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1658/11623.diff"
		eapply "${FILESDIR}/0.1658/12173.diff"
		eapply "${FILESDIR}/0.1658/12394.diff"
		eapply "${FILESDIR}/0.1658/12407.diff"
		eapply "${FILESDIR}/0.1658/12410.diff"
		eapply "${FILESDIR}/0.1658/12412.diff"
		eapply "${FILESDIR}/0.1658/4042.diff"
	fi
