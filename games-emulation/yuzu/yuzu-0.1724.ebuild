...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1724/12173.diff"
		eapply "${FILESDIR}/0.1724/12461.diff"
		eapply "${FILESDIR}/0.1724/12749.diff"
		eapply "${FILESDIR}/0.1724/13073.diff"
		eapply "${FILESDIR}/0.1724/13081.diff"
		eapply "${FILESDIR}/0.1724/13096.diff"
		eapply "${FILESDIR}/0.1724/13100.diff"
		eapply "${FILESDIR}/0.1724/13115.diff"
		eapply "${FILESDIR}/0.1724/4042.diff"
	fi
