...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1578/10519.diff"
		eapply "${FILESDIR}/0.1578/11534.diff"
		eapply "${FILESDIR}/0.1578/11535.diff"
		eapply "${FILESDIR}/0.1578/11650.diff"
		eapply "${FILESDIR}/0.1578/11669.diff"
		eapply "${FILESDIR}/0.1578/11677.diff"
		eapply "${FILESDIR}/0.1578/4042.diff"
	fi
