...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1475/10086.diff"
		eapply "${FILESDIR}/0.1475/10389.diff"
		eapply "${FILESDIR}/0.1475/10457.diff"
		eapply "${FILESDIR}/0.1475/10473.diff"
		eapply "${FILESDIR}/0.1475/10777.diff"
		eapply "${FILESDIR}/0.1475/4042.diff"
	fi
