...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1579/10519.diff"
		eapply "${FILESDIR}/0.1579/11534.diff"
		eapply "${FILESDIR}/0.1579/11535.diff"
		eapply "${FILESDIR}/0.1579/11639.diff"
		eapply "${FILESDIR}/0.1579/11648.diff"
		eapply "${FILESDIR}/0.1579/11650.diff"
		eapply "${FILESDIR}/0.1579/11669.diff"
		eapply "${FILESDIR}/0.1579/11677.diff"
		eapply "${FILESDIR}/0.1579/4042.diff"
	fi
