...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1427/10086.diff"
		eapply "${FILESDIR}/0.1427/10091.diff"
		eapply "${FILESDIR}/0.1427/10216.diff"
		eapply "${FILESDIR}/0.1427/10222.diff"
		eapply "${FILESDIR}/0.1427/4042.diff"
	fi
