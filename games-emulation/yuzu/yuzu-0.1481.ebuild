...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1481/10710.diff"
		eapply "${FILESDIR}/0.1481/10935.diff"
		eapply "${FILESDIR}/0.1481/10942.diff"
		eapply "${FILESDIR}/0.1481/10950.diff"
		eapply "${FILESDIR}/0.1481/10953.diff"
		eapply "${FILESDIR}/0.1481/4042.diff"
	fi
