...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1726/12173.diff"
		eapply "${FILESDIR}/0.1726/12461.diff"
		eapply "${FILESDIR}/0.1726/12749.diff"
		eapply "${FILESDIR}/0.1726/13018.diff"
		eapply "${FILESDIR}/0.1726/13096.diff"
		eapply "${FILESDIR}/0.1726/13154.diff"
		eapply "${FILESDIR}/0.1726/4042.diff"
	fi
