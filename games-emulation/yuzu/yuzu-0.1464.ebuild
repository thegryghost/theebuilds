...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1464/10086.diff"
		eapply "${FILESDIR}/0.1464/10389.diff"
		eapply "${FILESDIR}/0.1464/10486.diff"
		eapply "${FILESDIR}/0.1464/10603.diff"
		eapply "${FILESDIR}/0.1464/10668.diff"
		eapply "${FILESDIR}/0.1464/10670.diff"
		eapply "${FILESDIR}/0.1464/10675.diff"
		eapply "${FILESDIR}/0.1464/10685.diff"
		eapply "${FILESDIR}/0.1464/4042.diff"
	fi
