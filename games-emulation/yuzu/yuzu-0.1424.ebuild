...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1424/10086.diff"
		eapply "${FILESDIR}/0.1424/10132.diff"
		eapply "${FILESDIR}/0.1424/10181.diff"
		eapply "${FILESDIR}/0.1424/10183.diff"
		eapply "${FILESDIR}/0.1424/4042.diff"
	fi
