...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1646/11623.diff"
		eapply "${FILESDIR}/0.1646/12173.diff"
		eapply "${FILESDIR}/0.1646/12289.diff"
		eapply "${FILESDIR}/0.1646/12296.diff"
		eapply "${FILESDIR}/0.1646/12299.diff"
		eapply "${FILESDIR}/0.1646/12304.diff"
		eapply "${FILESDIR}/0.1646/4042.diff"
	fi
