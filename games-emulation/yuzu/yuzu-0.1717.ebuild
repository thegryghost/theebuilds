...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1717/10529.diff"
		eapply "${FILESDIR}/0.1717/12173.diff"
		eapply "${FILESDIR}/0.1717/12461.diff"
		eapply "${FILESDIR}/0.1717/12749.diff"
		eapply "${FILESDIR}/0.1717/12873.diff"
		eapply "${FILESDIR}/0.1717/12982.diff"
		eapply "${FILESDIR}/0.1717/13000.diff"
		eapply "${FILESDIR}/0.1717/13006.diff"
		eapply "${FILESDIR}/0.1717/13017.diff"
		eapply "${FILESDIR}/0.1717/13026.diff"
		eapply "${FILESDIR}/0.1717/4042.diff"
	fi
