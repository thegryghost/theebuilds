...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1550/10519.diff"
		eapply "${FILESDIR}/0.1550/11225.diff"
		eapply "${FILESDIR}/0.1550/11385.diff"
		eapply "${FILESDIR}/0.1550/11402.diff"
		eapply "${FILESDIR}/0.1550/11435.diff"
		eapply "${FILESDIR}/0.1550/11436.diff"
		eapply "${FILESDIR}/0.1550/11450.diff"
		eapply "${FILESDIR}/0.1550/11459.diff"
		eapply "${FILESDIR}/0.1550/4042.diff"
	fi
