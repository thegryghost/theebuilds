...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1655/11623.diff"
		eapply "${FILESDIR}/0.1655/12173.diff"
		eapply "${FILESDIR}/0.1655/12304.diff"
		eapply "${FILESDIR}/0.1655/12349.diff"
		eapply "${FILESDIR}/0.1655/12392.diff"
		eapply "${FILESDIR}/0.1655/4042.diff"
	fi
