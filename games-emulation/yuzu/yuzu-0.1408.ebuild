...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1408/10051.diff"
		eapply "${FILESDIR}/0.1408/10056.diff"
		eapply "${FILESDIR}/0.1408/10069.diff"
		eapply "${FILESDIR}/0.1408/10082.diff"
		eapply "${FILESDIR}/0.1408/4042.diff"
	fi
