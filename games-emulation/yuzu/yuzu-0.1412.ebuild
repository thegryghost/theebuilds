...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1412/10082.diff"
		eapply "${FILESDIR}/0.1412/10084.diff"
		eapply "${FILESDIR}/0.1412/10086.diff"
		eapply "${FILESDIR}/0.1412/10088.diff"
		eapply "${FILESDIR}/0.1412/4042.diff"
		eapply "${FILESDIR}/0.1412/9973.diff"
	fi
