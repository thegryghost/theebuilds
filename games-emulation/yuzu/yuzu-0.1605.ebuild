...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1605/11535.diff"
		eapply "${FILESDIR}/0.1605/11881.diff"
		eapply "${FILESDIR}/0.1605/11885.diff"
		eapply "${FILESDIR}/0.1605/11892.diff"
		eapply "${FILESDIR}/0.1605/11894.diff"
		eapply "${FILESDIR}/0.1605/11896.diff"
		eapply "${FILESDIR}/0.1605/11903.diff"
		eapply "${FILESDIR}/0.1605/4042.diff"
	fi
