...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1569/10519.diff"
		eapply "${FILESDIR}/0.1569/11402.diff"
		eapply "${FILESDIR}/0.1569/11493.diff"
		eapply "${FILESDIR}/0.1569/11535.diff"
		eapply "${FILESDIR}/0.1569/11556.diff"
		eapply "${FILESDIR}/0.1569/11590.diff"
		eapply "${FILESDIR}/0.1569/4042.diff"
	fi
