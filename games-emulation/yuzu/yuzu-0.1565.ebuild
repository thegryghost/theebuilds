...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1565/10519.diff"
		eapply "${FILESDIR}/0.1565/11165.diff"
		eapply "${FILESDIR}/0.1565/11225.diff"
		eapply "${FILESDIR}/0.1565/11402.diff"
		eapply "${FILESDIR}/0.1565/4042.diff"
	fi
