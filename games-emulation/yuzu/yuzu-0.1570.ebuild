...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1570/10519.diff"
		eapply "${FILESDIR}/0.1570/11402.diff"
		eapply "${FILESDIR}/0.1570/11493.diff"
		eapply "${FILESDIR}/0.1570/11556.diff"
		eapply "${FILESDIR}/0.1570/11590.diff"
		eapply "${FILESDIR}/0.1570/4042.diff"
	fi
