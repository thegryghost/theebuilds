...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1654/11623.diff"
		eapply "${FILESDIR}/0.1654/12173.diff"
		eapply "${FILESDIR}/0.1654/12304.diff"
		eapply "${FILESDIR}/0.1654/12349.diff"
		eapply "${FILESDIR}/0.1654/4042.diff"
	fi
