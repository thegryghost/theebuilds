...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1411/10082.diff"
		eapply "${FILESDIR}/0.1411/10084.diff"
		eapply "${FILESDIR}/0.1411/10086.diff"
		eapply "${FILESDIR}/0.1411/10088.diff"
		eapply "${FILESDIR}/0.1411/4042.diff"
		eapply "${FILESDIR}/0.1411/9973.diff"
	fi
