...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1389/10004.diff"
		eapply "${FILESDIR}/0.1389/10005.diff"
		eapply "${FILESDIR}/0.1389/10006.diff"
		eapply "${FILESDIR}/0.1389/10009.diff"
		eapply "${FILESDIR}/0.1389/10014.diff"
		eapply "${FILESDIR}/0.1389/4042.diff"
		eapply "${FILESDIR}/0.1389/9969.diff"
		eapply "${FILESDIR}/0.1389/9997.diff"
		eapply "${FILESDIR}/0.1389/9999.diff"
	fi
