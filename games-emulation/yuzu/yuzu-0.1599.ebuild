...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1599/11535.diff"
		eapply "${FILESDIR}/0.1599/11812.diff"
		eapply "${FILESDIR}/0.1599/11852.diff"
		eapply "${FILESDIR}/0.1599/11859.diff"
		eapply "${FILESDIR}/0.1599/4042.diff"
	fi
