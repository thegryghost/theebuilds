...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1413/10084.diff"
		eapply "${FILESDIR}/0.1413/10086.diff"
		eapply "${FILESDIR}/0.1413/10088.diff"
		eapply "${FILESDIR}/0.1413/4042.diff"
		eapply "${FILESDIR}/0.1413/9973.diff"
	fi
