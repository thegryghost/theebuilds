...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1388/10004.diff"
		eapply "${FILESDIR}/0.1388/10005.diff"
		eapply "${FILESDIR}/0.1388/10006.diff"
		eapply "${FILESDIR}/0.1388/4042.diff"
		eapply "${FILESDIR}/0.1388/9969.diff"
		eapply "${FILESDIR}/0.1388/9997.diff"
		eapply "${FILESDIR}/0.1388/9999.diff"
	fi
