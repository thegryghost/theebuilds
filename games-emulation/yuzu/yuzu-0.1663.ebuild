...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1663/12173.diff"
		eapply "${FILESDIR}/0.1663/12415.diff"
		eapply "${FILESDIR}/0.1663/12448.diff"
		eapply "${FILESDIR}/0.1663/12449.diff"
		eapply "${FILESDIR}/0.1663/12452.diff"
		eapply "${FILESDIR}/0.1663/12455.diff"
		eapply "${FILESDIR}/0.1663/12465.diff"
		eapply "${FILESDIR}/0.1663/12467.diff"
		eapply "${FILESDIR}/0.1663/4042.diff"
	fi
