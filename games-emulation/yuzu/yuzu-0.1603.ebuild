...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1603/11535.diff"
		eapply "${FILESDIR}/0.1603/11689.diff"
		eapply "${FILESDIR}/0.1603/11728.diff"
		eapply "${FILESDIR}/0.1603/11827.diff"
		eapply "${FILESDIR}/0.1603/11843.diff"
		eapply "${FILESDIR}/0.1603/11852.diff"
		eapply "${FILESDIR}/0.1603/11859.diff"
		eapply "${FILESDIR}/0.1603/11862.diff"
		eapply "${FILESDIR}/0.1603/11866.diff"
		eapply "${FILESDIR}/0.1603/4042.diff"
	fi
