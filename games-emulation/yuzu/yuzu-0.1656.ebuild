...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1656/11623.diff"
		eapply "${FILESDIR}/0.1656/12173.diff"
		eapply "${FILESDIR}/0.1656/12304.diff"
		eapply "${FILESDIR}/0.1656/12390.diff"
		eapply "${FILESDIR}/0.1656/12392.diff"
		eapply "${FILESDIR}/0.1656/12400.diff"
		eapply "${FILESDIR}/0.1656/12403.diff"
		eapply "${FILESDIR}/0.1656/4042.diff"
	fi
