...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1576/10519.diff"
		eapply "${FILESDIR}/0.1576/11535.diff"
		eapply "${FILESDIR}/0.1576/11639.diff"
		eapply "${FILESDIR}/0.1576/11648.diff"
		eapply "${FILESDIR}/0.1576/11650.diff"
		eapply "${FILESDIR}/0.1576/4042.diff"
	fi
