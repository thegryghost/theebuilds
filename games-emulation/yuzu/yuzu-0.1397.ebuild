...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1397/10008.diff"
		eapply "${FILESDIR}/0.1397/10014.diff"
		eapply "${FILESDIR}/0.1397/10027.diff"
		eapply "${FILESDIR}/0.1397/10030.diff"
		eapply "${FILESDIR}/0.1397/4042.diff"
	fi
