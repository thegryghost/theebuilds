...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1684/12173.diff"
		eapply "${FILESDIR}/0.1684/12579.diff"
		eapply "${FILESDIR}/0.1684/12644.diff"
		eapply "${FILESDIR}/0.1684/12688.diff"
		eapply "${FILESDIR}/0.1684/4042.diff"
	fi
