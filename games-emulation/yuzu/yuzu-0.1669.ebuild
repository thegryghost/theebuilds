...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1669/12173.diff"
		eapply "${FILESDIR}/0.1669/12437.diff"
		eapply "${FILESDIR}/0.1669/12454.diff"
		eapply "${FILESDIR}/0.1669/12466.diff"
		eapply "${FILESDIR}/0.1669/12501.diff"
		eapply "${FILESDIR}/0.1669/12513.diff"
		eapply "${FILESDIR}/0.1669/12543.diff"
		eapply "${FILESDIR}/0.1669/4042.diff"
	fi
