...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1652/11623.diff"
		eapply "${FILESDIR}/0.1652/12184.diff"
		eapply "${FILESDIR}/0.1652/12344.diff"
		eapply "${FILESDIR}/0.1652/12345.diff"
		eapply "${FILESDIR}/0.1652/12349.diff"
		eapply "${FILESDIR}/0.1652/12358.diff"
		eapply "${FILESDIR}/0.1652/12359.diff"
		eapply "${FILESDIR}/0.1652/4042.diff"
	fi
