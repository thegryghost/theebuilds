...
GOOGLETEST_SHA="f8d7d77c06936315286eb55f8de22cd23c188571"
BUILD_DEPS_SHA="a51a06adf774c51f6a3916b4fe10ca7d436690d3"
...
SRC_URI="https://github.com/lizardbyte/sunshine/archive/v2025.531.32111.tar.gz -> ${P}.tar.gz
...
src_unpack() {
	...
	#sed -e "s#https://github.com/boostorg/boost/releases/download/boost-${BOOST_VERSION}/boost-${BOOST_VERSION}-cmake.tar.xz#file://${DISTDIR}/boost-${BOOST_VER}-cmake.tar.xz#g" -i "$S/cmake/dependencies/Boost_Sunshine.cmake"
