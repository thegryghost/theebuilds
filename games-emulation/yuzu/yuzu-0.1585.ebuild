...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1585/11535.diff"
		eapply "${FILESDIR}/0.1585/11653.diff"
		eapply "${FILESDIR}/0.1585/11720.diff"
		eapply "${FILESDIR}/0.1585/11740.diff"
		eapply "${FILESDIR}/0.1585/11744.diff"
		eapply "${FILESDIR}/0.1585/4042.diff"
	fi
