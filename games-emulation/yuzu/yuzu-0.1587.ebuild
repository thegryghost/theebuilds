...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1587/11349.diff"
		eapply "${FILESDIR}/0.1587/11535.diff"
		eapply "${FILESDIR}/0.1587/11653.diff"
		eapply "${FILESDIR}/0.1587/11689.diff"
		eapply "${FILESDIR}/0.1587/11747.diff"
		eapply "${FILESDIR}/0.1587/11748.diff"
		eapply "${FILESDIR}/0.1587/11762.diff"
		eapply "${FILESDIR}/0.1587/4042.diff"
	fi
