...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1414/10084.diff"
		eapply "${FILESDIR}/0.1414/10086.diff"
		eapply "${FILESDIR}/0.1414/10088.diff"
		eapply "${FILESDIR}/0.1414/10110.diff"
		eapply "${FILESDIR}/0.1414/4042.diff"
		eapply "${FILESDIR}/0.1414/9973.diff"
	fi
