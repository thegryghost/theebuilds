...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1433/10086.diff"
		eapply "${FILESDIR}/0.1433/10091.diff"
		eapply "${FILESDIR}/0.1433/10107.diff"
		eapply "${FILESDIR}/0.1433/10221.diff"
		eapply "${FILESDIR}/0.1433/10254.diff"
		eapply "${FILESDIR}/0.1433/10265.diff"
		eapply "${FILESDIR}/0.1433/10288.diff"
		eapply "${FILESDIR}/0.1433/4042.diff"
	fi
