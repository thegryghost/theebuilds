...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1406/10048.diff"
		eapply "${FILESDIR}/0.1406/10051.diff"
		eapply "${FILESDIR}/0.1406/10053.diff"
		eapply "${FILESDIR}/0.1406/10056.diff"
		eapply "${FILESDIR}/0.1406/10057.diff"
		eapply "${FILESDIR}/0.1406/4042.diff"
	fi
