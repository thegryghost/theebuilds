...
src_prepare() {
	...
	#epatch "${FILESDIR}"/04_osmesa_version.diff
	#epatch "${FILESDIR}"/101_ubuntu_hidden_glname.patch
	epatch "${FILESDIR}"/120-hide-x86sse.patch
	epatch "${FILESDIR}"/llvm-3.4.patch
	epatch "${FILESDIR}"/motion_adaptive_deinterlacer.patch
