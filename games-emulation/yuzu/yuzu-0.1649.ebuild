...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1649/11623.diff"
		eapply "${FILESDIR}/0.1649/12173.diff"
		eapply "${FILESDIR}/0.1649/12184.diff"
		eapply "${FILESDIR}/0.1649/12304.diff"
		eapply "${FILESDIR}/0.1649/12328.diff"
		eapply "${FILESDIR}/0.1649/12331.diff"
		eapply "${FILESDIR}/0.1649/12333.diff"
		eapply "${FILESDIR}/0.1649/4042.diff"
	fi
