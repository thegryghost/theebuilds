...
src_unpack() {
	...
	cp ${FILESDIR}/wmapro_soc/wmaprodata.h ${WORKDIR}/ffmpeg-${PV}/libavcodec
	cp ${FILESDIR}/wmapro_soc/wmaprodec.c ${WORKDIR}/ffmpeg-${PV}/libavcodec
	cd ${WORKDIR}/ffmpeg-${PV}
	epatch ${FILESDIR}/wmapro_soc/wmapro_ffmpeg.patch
	epatch ${FILESDIR}/wmapro_soc/audioframesize.patch
}
