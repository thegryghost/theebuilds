...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1559/10519.diff"
		eapply "${FILESDIR}/0.1559/11225.diff"
		eapply "${FILESDIR}/0.1559/11402.diff"
		eapply "${FILESDIR}/0.1559/11460.diff"
		eapply "${FILESDIR}/0.1559/11483.diff"
		eapply "${FILESDIR}/0.1559/11492.diff"
		eapply "${FILESDIR}/0.1559/11499.diff"
		eapply "${FILESDIR}/0.1559/4042.diff"
	fi
