...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1636/11623.diff"
		eapply "${FILESDIR}/0.1636/11902.diff"
		eapply "${FILESDIR}/0.1636/12154.diff"
		eapply "${FILESDIR}/0.1636/12173.diff"
		eapply "${FILESDIR}/0.1636/12201.diff"
		eapply "${FILESDIR}/0.1636/12203.diff"
		eapply "${FILESDIR}/0.1636/4042.diff"
	fi
