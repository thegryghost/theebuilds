...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1729/12461.diff"
		eapply "${FILESDIR}/0.1729/13018.diff"
		eapply "${FILESDIR}/0.1729/13174.diff"
		eapply "${FILESDIR}/0.1729/13177.diff"
		eapply "${FILESDIR}/0.1729/13178.diff"
		eapply "${FILESDIR}/0.1729/13184.diff"
		eapply "${FILESDIR}/0.1729/4042.diff"
	fi
