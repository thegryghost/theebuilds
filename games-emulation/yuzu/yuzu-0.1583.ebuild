...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1583/11144.diff"
		eapply "${FILESDIR}/0.1583/11534.diff"
		eapply "${FILESDIR}/0.1583/11535.diff"
		eapply "${FILESDIR}/0.1583/11683.diff"
		eapply "${FILESDIR}/0.1583/11734.diff"
		eapply "${FILESDIR}/0.1583/11735.diff"
		eapply "${FILESDIR}/0.1583/4042.diff"
	fi
