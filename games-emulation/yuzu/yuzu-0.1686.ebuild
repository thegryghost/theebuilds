...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1686/12173.diff"
		eapply "${FILESDIR}/0.1686/12579.diff"
		eapply "${FILESDIR}/0.1686/12644.diff"
		eapply "${FILESDIR}/0.1686/12660.diff"
		eapply "${FILESDIR}/0.1686/12678.diff"
		eapply "${FILESDIR}/0.1686/12683.diff"
		eapply "${FILESDIR}/0.1686/12687.diff"
		eapply "${FILESDIR}/0.1686/12688.diff"
		eapply "${FILESDIR}/0.1686/4042.diff"
	fi
