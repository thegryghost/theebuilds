...
VULKAN_UTILITY_LIBRARIES_SHA="524f8910d0e4a5f2ec5961996b23e5b74b95cb1d"
...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1718/10529.diff"
		eapply "${FILESDIR}/0.1718/12173.diff"
		eapply "${FILESDIR}/0.1718/12461.diff"
		eapply "${FILESDIR}/0.1718/12749.diff"
		eapply "${FILESDIR}/0.1718/12873.diff"
		eapply "${FILESDIR}/0.1718/13000.diff"
		eapply "${FILESDIR}/0.1718/13006.diff"
		eapply "${FILESDIR}/0.1718/13026.diff"
		eapply "${FILESDIR}/0.1718/13030.diff"
		eapply "${FILESDIR}/0.1718/13032.diff"
		eapply "${FILESDIR}/0.1718/13035.diff"
		eapply "${FILESDIR}/0.1718/13048.diff"
		eapply "${FILESDIR}/0.1718/4042.diff"
	fi
