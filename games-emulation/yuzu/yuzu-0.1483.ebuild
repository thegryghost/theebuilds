...
VULKAN_HEADERS_SHA="63af1cf1ee906ba4dcd5a324bdd0201d4f4bfd12"
VULKANMEMORYALLOCATOR_SHA="0aa3989b8f382f185fdf646cc83a1d16fa31d6ab"
...
src_prepare() {
	...
	rmdir "${S}/externals/vma/VulkanMemoryAllocator"
	mv "${WORKDIR}/VulkanMemoryAllocator-${VULKANMEMORYALLOCATOR_SHA}" "${S}/externals/vma/VulkanMemoryAllocator" || die
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1483/10479.diff"
		eapply "${FILESDIR}/0.1483/10710.diff"
		eapply "${FILESDIR}/0.1483/10942.diff"
		eapply "${FILESDIR}/0.1483/10950.diff"
		eapply "${FILESDIR}/0.1483/10966.diff"
		eapply "${FILESDIR}/0.1483/10969.diff"
		eapply "${FILESDIR}/0.1483/10970.diff"
		eapply "${FILESDIR}/0.1483/4042.diff"
	fi
