...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1623/11535.diff"
		eapply "${FILESDIR}/0.1623/11623.diff"
		eapply "${FILESDIR}/0.1623/11792.diff"
		eapply "${FILESDIR}/0.1623/11889.diff"
		eapply "${FILESDIR}/0.1623/11912.diff"
		eapply "${FILESDIR}/0.1623/11917.diff"
		eapply "${FILESDIR}/0.1623/12045.diff"
		eapply "${FILESDIR}/0.1623/12058.diff"
		eapply "${FILESDIR}/0.1623/4042.diff"
	fi
