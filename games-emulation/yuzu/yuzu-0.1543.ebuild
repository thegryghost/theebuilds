...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1543/10048.diff"
		eapply "${FILESDIR}/0.1543/10519.diff"
		eapply "${FILESDIR}/0.1543/11225.diff"
		eapply "${FILESDIR}/0.1543/11381.diff"
		eapply "${FILESDIR}/0.1543/11383.diff"
		eapply "${FILESDIR}/0.1543/11384.diff"
		eapply "${FILESDIR}/0.1543/11385.diff"
		eapply "${FILESDIR}/0.1543/11393.diff"
		eapply "${FILESDIR}/0.1543/11402.diff"
		eapply "${FILESDIR}/0.1543/11412.diff"
		eapply "${FILESDIR}/0.1543/4042.diff"
	fi
