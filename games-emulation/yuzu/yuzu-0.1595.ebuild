...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1595/11535.diff"
		eapply "${FILESDIR}/0.1595/11689.diff"
		eapply "${FILESDIR}/0.1595/11789.diff"
		eapply "${FILESDIR}/0.1595/11827.diff"
		eapply "${FILESDIR}/0.1595/4042.diff"
	fi
