...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1580/10519.diff"
		eapply "${FILESDIR}/0.1580/11534.diff"
		eapply "${FILESDIR}/0.1580/11535.diff"
		eapply "${FILESDIR}/0.1580/11639.diff"
		eapply "${FILESDIR}/0.1580/11648.diff"
		eapply "${FILESDIR}/0.1580/11650.diff"
		eapply "${FILESDIR}/0.1580/11669.diff"
		eapply "${FILESDIR}/0.1580/11684.diff"
		eapply "${FILESDIR}/0.1580/4042.diff"
	fi
