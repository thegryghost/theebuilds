...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1638/11623.diff"
		eapply "${FILESDIR}/0.1638/12094.diff"
		eapply "${FILESDIR}/0.1638/12173.diff"
		eapply "${FILESDIR}/0.1638/12235.diff"
		eapply "${FILESDIR}/0.1638/12236.diff"
		eapply "${FILESDIR}/0.1638/4042.diff"
	fi
