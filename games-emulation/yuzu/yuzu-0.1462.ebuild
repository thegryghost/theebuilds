...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1462/10086.diff"
		eapply "${FILESDIR}/0.1462/10389.diff"
		eapply "${FILESDIR}/0.1462/10614.diff"
		eapply "${FILESDIR}/0.1462/10623.diff"
		eapply "${FILESDIR}/0.1462/10666.diff"
		eapply "${FILESDIR}/0.1462/10668.diff"
		eapply "${FILESDIR}/0.1462/4042.diff"
	fi
