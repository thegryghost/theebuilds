...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1657/11623.diff"
		eapply "${FILESDIR}/0.1657/12390.diff"
		eapply "${FILESDIR}/0.1657/12394.diff"
		eapply "${FILESDIR}/0.1657/12400.diff"
		eapply "${FILESDIR}/0.1657/12403.diff"
		eapply "${FILESDIR}/0.1657/4042.diff"
	fi
