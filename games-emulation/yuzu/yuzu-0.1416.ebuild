...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1416/10086.diff"
		eapply "${FILESDIR}/0.1416/10088.diff"
		eapply "${FILESDIR}/0.1416/10117.diff"
		eapply "${FILESDIR}/0.1416/10123.diff"
		eapply "${FILESDIR}/0.1416/10124.diff"
		eapply "${FILESDIR}/0.1416/10130.diff"
		eapply "${FILESDIR}/0.1416/4042.diff"
		eapply "${FILESDIR}/0.1416/9973.diff"
	fi
