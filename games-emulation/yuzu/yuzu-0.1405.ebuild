...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1405/10048.diff"
		eapply "${FILESDIR}/0.1405/10051.diff"
		eapply "${FILESDIR}/0.1405/10053.diff"
		eapply "${FILESDIR}/0.1405/10056.diff"
		eapply "${FILESDIR}/0.1405/10057.diff"
		eapply "${FILESDIR}/0.1405/4042.diff"
	fi
