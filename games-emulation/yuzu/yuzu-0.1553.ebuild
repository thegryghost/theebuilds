...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1553/10519.diff"
		eapply "${FILESDIR}/0.1553/11225.diff"
		eapply "${FILESDIR}/0.1553/11385.diff"
		eapply "${FILESDIR}/0.1553/11402.diff"
		eapply "${FILESDIR}/0.1553/11435.diff"
		eapply "${FILESDIR}/0.1553/11436.diff"
		eapply "${FILESDIR}/0.1553/11450.diff"
		eapply "${FILESDIR}/0.1553/11456.diff"
		eapply "${FILESDIR}/0.1553/11459.diff"
		eapply "${FILESDIR}/0.1553/11465.diff"
		eapply "${FILESDIR}/0.1553/11467.diff"
		eapply "${FILESDIR}/0.1553/4042.diff"
	fi
