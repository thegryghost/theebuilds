...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1582/11144.diff"
		eapply "${FILESDIR}/0.1582/11534.diff"
		eapply "${FILESDIR}/0.1582/11535.diff"
		eapply "${FILESDIR}/0.1582/11650.diff"
		eapply "${FILESDIR}/0.1582/11683.diff"
		eapply "${FILESDIR}/0.1582/11686.diff"
		eapply "${FILESDIR}/0.1582/4042.diff"
	fi
