...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1624/11535.diff"
		eapply "${FILESDIR}/0.1624/11623.diff"
		eapply "${FILESDIR}/0.1624/11792.diff"
		eapply "${FILESDIR}/0.1624/11889.diff"
		eapply "${FILESDIR}/0.1624/11912.diff"
		eapply "${FILESDIR}/0.1624/11917.diff"
		eapply "${FILESDIR}/0.1624/12045.diff"
		eapply "${FILESDIR}/0.1624/12058.diff"
		eapply "${FILESDIR}/0.1624/4042.diff"
	fi
