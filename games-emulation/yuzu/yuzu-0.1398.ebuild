...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1398/10008.diff"
		eapply "${FILESDIR}/0.1398/10027.diff"
		eapply "${FILESDIR}/0.1398/10030.diff"
		eapply "${FILESDIR}/0.1398/10035.diff"
		eapply "${FILESDIR}/0.1398/4042.diff"
		eapply "${FILESDIR}/0.1398/9973.diff"
	fi
