...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1542/10048.diff"
		eapply "${FILESDIR}/0.1542/10519.diff"
		eapply "${FILESDIR}/0.1542/11225.diff"
		eapply "${FILESDIR}/0.1542/11381.diff"
		eapply "${FILESDIR}/0.1542/11383.diff"
		eapply "${FILESDIR}/0.1542/11384.diff"
		eapply "${FILESDIR}/0.1542/11385.diff"
		eapply "${FILESDIR}/0.1542/11393.diff"
		eapply "${FILESDIR}/0.1542/11402.diff"
		eapply "${FILESDIR}/0.1542/11412.diff"
		eapply "${FILESDIR}/0.1542/4042.diff"
	fi
