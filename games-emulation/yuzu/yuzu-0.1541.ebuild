...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1541/10048.diff"
		eapply "${FILESDIR}/0.1541/10519.diff"
		eapply "${FILESDIR}/0.1541/11225.diff"
		eapply "${FILESDIR}/0.1541/11381.diff"
		eapply "${FILESDIR}/0.1541/11383.diff"
		eapply "${FILESDIR}/0.1541/11384.diff"
		eapply "${FILESDIR}/0.1541/11385.diff"
		eapply "${FILESDIR}/0.1541/11393.diff"
		eapply "${FILESDIR}/0.1541/11402.diff"
		eapply "${FILESDIR}/0.1541/4042.diff"
	fi
