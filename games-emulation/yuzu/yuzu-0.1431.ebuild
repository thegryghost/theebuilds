...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1431/10086.diff"
		eapply "${FILESDIR}/0.1431/10091.diff"
		eapply "${FILESDIR}/0.1431/10107.diff"
		eapply "${FILESDIR}/0.1431/10181.diff"
		eapply "${FILESDIR}/0.1431/10221.diff"
		eapply "${FILESDIR}/0.1431/10234.diff"
		eapply "${FILESDIR}/0.1431/10249.diff"
		eapply "${FILESDIR}/0.1431/10254.diff"
		eapply "${FILESDIR}/0.1431/10262.diff"
		eapply "${FILESDIR}/0.1431/4042.diff"
	fi
