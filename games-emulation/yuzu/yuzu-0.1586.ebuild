...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1586/11535.diff"
		eapply "${FILESDIR}/0.1586/11653.diff"
		eapply "${FILESDIR}/0.1586/11751.diff"
		eapply "${FILESDIR}/0.1586/11753.diff"
		eapply "${FILESDIR}/0.1586/11762.diff"
		eapply "${FILESDIR}/0.1586/4042.diff"
	fi
