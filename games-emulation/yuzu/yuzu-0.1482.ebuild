...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1482/10479.diff"
		eapply "${FILESDIR}/0.1482/10710.diff"
		eapply "${FILESDIR}/0.1482/10942.diff"
		eapply "${FILESDIR}/0.1482/10950.diff"
		eapply "${FILESDIR}/0.1482/10953.diff"
		eapply "${FILESDIR}/0.1482/10966.diff"
		eapply "${FILESDIR}/0.1482/4042.diff"
	fi
