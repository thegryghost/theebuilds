...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1679/12173.diff"
		eapply "${FILESDIR}/0.1679/12380.diff"
		eapply "${FILESDIR}/0.1679/12579.diff"
		eapply "${FILESDIR}/0.1679/12605.diff"
		eapply "${FILESDIR}/0.1679/12610.diff"
		eapply "${FILESDIR}/0.1679/12611.diff"
		eapply "${FILESDIR}/0.1679/12612.diff"
		eapply "${FILESDIR}/0.1679/4042.diff"
	fi
