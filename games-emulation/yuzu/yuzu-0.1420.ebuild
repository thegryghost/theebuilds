...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1420/10086.diff"
		eapply "${FILESDIR}/0.1420/10128.diff"
		eapply "${FILESDIR}/0.1420/10145.diff"
		eapply "${FILESDIR}/0.1420/10155.diff"
		eapply "${FILESDIR}/0.1420/4042.diff"
	fi
