...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1552/10519.diff"
		eapply "${FILESDIR}/0.1552/11225.diff"
		eapply "${FILESDIR}/0.1552/11402.diff"
		eapply "${FILESDIR}/0.1552/11436.diff"
		eapply "${FILESDIR}/0.1552/11450.diff"
		eapply "${FILESDIR}/0.1552/11456.diff"
		eapply "${FILESDIR}/0.1552/11465.diff"
		eapply "${FILESDIR}/0.1552/11467.diff"
		eapply "${FILESDIR}/0.1552/4042.diff"
	fi
