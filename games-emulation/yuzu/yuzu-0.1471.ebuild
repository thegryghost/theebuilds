...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1471/10086.diff"
		eapply "${FILESDIR}/0.1471/10389.diff"
		eapply "${FILESDIR}/0.1471/10457.diff"
		eapply "${FILESDIR}/0.1471/10486.diff"
		eapply "${FILESDIR}/0.1471/10731.diff"
		eapply "${FILESDIR}/0.1471/10777.diff"
		eapply "${FILESDIR}/0.1471/10783.diff"
		eapply "${FILESDIR}/0.1471/4042.diff"
	fi
