...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1415/10084.diff"
		eapply "${FILESDIR}/0.1415/10086.diff"
		eapply "${FILESDIR}/0.1415/10088.diff"
		eapply "${FILESDIR}/0.1415/10116.diff"
		eapply "${FILESDIR}/0.1415/4042.diff"
		eapply "${FILESDIR}/0.1415/9973.diff"
	fi
