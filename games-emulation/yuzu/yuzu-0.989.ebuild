...
src_install() {
	...
	mv "${D}/usr/share/applications/yuzu.desktop" "${D}/usr/share/applications/yuzu-mainline.desktop"
	mv "${D}/usr/share/icons/hicolor/scalable/apps/yuzu.svg" "${D}/usr/share/icons/hicolor/scalable/apps/yuzu-mainline.svg"
	mv "${D}/usr/share/mime/packages/yuzu.xml" "${D}/usr/share/mime/packages/yuzu-mainline.xml"
}
