...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1438/10086.diff"
		eapply "${FILESDIR}/0.1438/10091.diff"
		eapply "${FILESDIR}/0.1438/10344.diff"
		eapply "${FILESDIR}/0.1438/10362.diff"
		eapply "${FILESDIR}/0.1438/4042.diff"
	fi
