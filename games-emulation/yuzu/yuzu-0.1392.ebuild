...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1392/10008.diff"
		eapply "${FILESDIR}/0.1392/10009.diff"
		eapply "${FILESDIR}/0.1392/10014.diff"
		eapply "${FILESDIR}/0.1392/10024.diff"
		eapply "${FILESDIR}/0.1392/4042.diff"
	fi
