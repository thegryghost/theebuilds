...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1592/11535.diff"
		eapply "${FILESDIR}/0.1592/11689.diff"
		eapply "${FILESDIR}/0.1592/11748.diff"
		eapply "${FILESDIR}/0.1592/11806.diff"
		eapply "${FILESDIR}/0.1592/4042.diff"
	fi
