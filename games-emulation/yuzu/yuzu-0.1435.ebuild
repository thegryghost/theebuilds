...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1435/10086.diff"
		eapply "${FILESDIR}/0.1435/10091.diff"
		eapply "${FILESDIR}/0.1435/10107.diff"
		eapply "${FILESDIR}/0.1435/10254.diff"
		eapply "${FILESDIR}/0.1435/10265.diff"
		eapply "${FILESDIR}/0.1435/10302.diff"
		eapply "${FILESDIR}/0.1435/4042.diff"
	fi
