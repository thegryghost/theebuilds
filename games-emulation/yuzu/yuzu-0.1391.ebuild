...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1391/10004.diff"
		eapply "${FILESDIR}/0.1391/10008.diff"
		eapply "${FILESDIR}/0.1391/10009.diff"
		eapply "${FILESDIR}/0.1391/10014.diff"
		eapply "${FILESDIR}/0.1391/10024.diff"
		eapply "${FILESDIR}/0.1391/4042.diff"
	fi
