...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1622/11535.diff"
		eapply "${FILESDIR}/0.1622/11623.diff"
		eapply "${FILESDIR}/0.1622/11792.diff"
		eapply "${FILESDIR}/0.1622/11889.diff"
		eapply "${FILESDIR}/0.1622/11912.diff"
		eapply "${FILESDIR}/0.1622/11917.diff"
		eapply "${FILESDIR}/0.1622/12045.diff"
		eapply "${FILESDIR}/0.1622/4042.diff"
	fi
