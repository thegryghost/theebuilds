...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1417/10086.diff"
		eapply "${FILESDIR}/0.1417/10088.diff"
		eapply "${FILESDIR}/0.1417/10117.diff"
		eapply "${FILESDIR}/0.1417/10123.diff"
		eapply "${FILESDIR}/0.1417/10124.diff"
		eapply "${FILESDIR}/0.1417/10130.diff"
		eapply "${FILESDIR}/0.1417/4042.diff"
		eapply "${FILESDIR}/0.1417/9973.diff"
	fi
