...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1472/10086.diff"
		eapply "${FILESDIR}/0.1472/10389.diff"
		eapply "${FILESDIR}/0.1472/10457.diff"
		eapply "${FILESDIR}/0.1472/10486.diff"
		eapply "${FILESDIR}/0.1472/10744.diff"
		eapply "${FILESDIR}/0.1472/10777.diff"
		eapply "${FILESDIR}/0.1472/10797.diff"
		eapply "${FILESDIR}/0.1472/10798.diff"
		eapply "${FILESDIR}/0.1472/10809.diff"
		eapply "${FILESDIR}/0.1472/4042.diff"
	fi
