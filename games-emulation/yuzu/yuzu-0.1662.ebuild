...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1662/12173.diff"
		eapply "${FILESDIR}/0.1662/12415.diff"
		eapply "${FILESDIR}/0.1662/12448.diff"
		eapply "${FILESDIR}/0.1662/12449.diff"
		eapply "${FILESDIR}/0.1662/12452.diff"
		eapply "${FILESDIR}/0.1662/12455.diff"
		eapply "${FILESDIR}/0.1662/12465.diff"
		eapply "${FILESDIR}/0.1662/12467.diff"
		eapply "${FILESDIR}/0.1662/4042.diff"
	fi
