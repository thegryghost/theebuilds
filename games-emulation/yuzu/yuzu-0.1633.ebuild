...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1633/11535.diff"
		eapply "${FILESDIR}/0.1633/11623.diff"
		eapply "${FILESDIR}/0.1633/12154.diff"
		eapply "${FILESDIR}/0.1633/12160.diff"
		eapply "${FILESDIR}/0.1633/12183.diff"
		eapply "${FILESDIR}/0.1633/4042.diff"
	fi
