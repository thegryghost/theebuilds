...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1693/12173.diff"
		eapply "${FILESDIR}/0.1693/12499.diff"
		eapply "${FILESDIR}/0.1693/12749.diff"
		eapply "${FILESDIR}/0.1693/12759.diff"
		eapply "${FILESDIR}/0.1693/12769.diff"
		eapply "${FILESDIR}/0.1693/4042.diff"
	fi
