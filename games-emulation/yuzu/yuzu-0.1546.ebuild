...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1546/10519.diff"
		eapply "${FILESDIR}/0.1546/11225.diff"
		eapply "${FILESDIR}/0.1546/11402.diff"
		eapply "${FILESDIR}/0.1546/11428.diff"
		eapply "${FILESDIR}/0.1546/11435.diff"
		eapply "${FILESDIR}/0.1546/11437.diff"
		eapply "${FILESDIR}/0.1546/4042.diff"
	fi
