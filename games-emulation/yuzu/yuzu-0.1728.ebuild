...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1728/12461.diff"
		eapply "${FILESDIR}/0.1728/13018.diff"
		eapply "${FILESDIR}/0.1728/13135.diff"
		eapply "${FILESDIR}/0.1728/13174.diff"
		eapply "${FILESDIR}/0.1728/13177.diff"
		eapply "${FILESDIR}/0.1728/13178.diff"
		eapply "${FILESDIR}/0.1728/4042.diff"
	fi
