...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1487/10912.diff"
		eapply "${FILESDIR}/0.1487/10996.diff"
		eapply "${FILESDIR}/0.1487/10999.diff"
		eapply "${FILESDIR}/0.1487/11016.diff"
		eapply "${FILESDIR}/0.1487/11022.diff"
		eapply "${FILESDIR}/0.1487/4042.diff"
	fi
