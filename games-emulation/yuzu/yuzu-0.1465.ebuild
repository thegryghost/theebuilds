...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1465/10086.diff"
		eapply "${FILESDIR}/0.1465/10389.diff"
		eapply "${FILESDIR}/0.1465/10668.diff"
		eapply "${FILESDIR}/0.1465/10675.diff"
		eapply "${FILESDIR}/0.1465/10693.diff"
		eapply "${FILESDIR}/0.1465/10699.diff"
		eapply "${FILESDIR}/0.1465/4042.diff"
	fi
