...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1665/12173.diff"
		eapply "${FILESDIR}/0.1665/12437.diff"
		eapply "${FILESDIR}/0.1665/12452.diff"
		eapply "${FILESDIR}/0.1665/12454.diff"
		eapply "${FILESDIR}/0.1665/12466.diff"
		eapply "${FILESDIR}/0.1665/12479.diff"
		eapply "${FILESDIR}/0.1665/12487.diff"
		eapply "${FILESDIR}/0.1665/4042.diff"
	fi
