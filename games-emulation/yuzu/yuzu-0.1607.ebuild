...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1607/11535.diff"
		eapply "${FILESDIR}/0.1607/11873.diff"
		eapply "${FILESDIR}/0.1607/11881.diff"
		eapply "${FILESDIR}/0.1607/11885.diff"
		eapply "${FILESDIR}/0.1607/11894.diff"
		eapply "${FILESDIR}/0.1607/11896.diff"
		eapply "${FILESDIR}/0.1607/11936.diff"
		eapply "${FILESDIR}/0.1607/4042.diff"
	fi
