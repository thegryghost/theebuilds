...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1716/10529.diff"
		eapply "${FILESDIR}/0.1716/12173.diff"
		eapply "${FILESDIR}/0.1716/12461.diff"
		eapply "${FILESDIR}/0.1716/12749.diff"
		eapply "${FILESDIR}/0.1716/12873.diff"
		eapply "${FILESDIR}/0.1716/13000.diff"
		eapply "${FILESDIR}/0.1716/13011.diff"
		eapply "${FILESDIR}/0.1716/13016.diff"
		eapply "${FILESDIR}/0.1716/13017.diff"
		eapply "${FILESDIR}/0.1716/13026.diff"
		eapply "${FILESDIR}/0.1716/4042.diff"
	fi
