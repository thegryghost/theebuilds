...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1430/10086.diff"
		eapply "${FILESDIR}/0.1430/10091.diff"
		eapply "${FILESDIR}/0.1430/10107.diff"
		eapply "${FILESDIR}/0.1430/10221.diff"
		eapply "${FILESDIR}/0.1430/10254.diff"
		eapply "${FILESDIR}/0.1430/4042.diff"
	fi
