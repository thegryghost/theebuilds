...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1723/12461.diff"
		eapply "${FILESDIR}/0.1723/13073.diff"
		eapply "${FILESDIR}/0.1723/13081.diff"
		eapply "${FILESDIR}/0.1723/13096.diff"
		eapply "${FILESDIR}/0.1723/13100.diff"
		eapply "${FILESDIR}/0.1723/13115.diff"
		eapply "${FILESDIR}/0.1723/13117.diff"
		eapply "${FILESDIR}/0.1723/4042.diff"
	fi
