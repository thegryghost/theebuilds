...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1590/11349.diff"
		eapply "${FILESDIR}/0.1590/11535.diff"
		eapply "${FILESDIR}/0.1590/11653.diff"
		eapply "${FILESDIR}/0.1590/11689.diff"
		eapply "${FILESDIR}/0.1590/11747.diff"
		eapply "${FILESDIR}/0.1590/11748.diff"
		eapply "${FILESDIR}/0.1590/11762.diff"
		eapply "${FILESDIR}/0.1590/11774.diff"
		eapply "${FILESDIR}/0.1590/11791.diff"
		eapply "${FILESDIR}/0.1590/4042.diff"
	fi
