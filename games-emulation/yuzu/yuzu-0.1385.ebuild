...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1385/4042.diff"
		eapply "${FILESDIR}/0.1385/9505.diff"
		eapply "${FILESDIR}/0.1385/9982.diff"
		eapply "${FILESDIR}/0.1385/9984.diff"
		eapply "${FILESDIR}/0.1385/9995.diff"
	fi
