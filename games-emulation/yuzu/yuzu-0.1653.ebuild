...
TZDB_TO_NX_SHA="f6680093bca30265c161581fd813d4ddd33f1e3e"
...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1653/11623.diff"
		eapply "${FILESDIR}/0.1653/12173.diff"
		eapply "${FILESDIR}/0.1653/12184.diff"
		eapply "${FILESDIR}/0.1653/12290.diff"
		eapply "${FILESDIR}/0.1653/12304.diff"
		eapply "${FILESDIR}/0.1653/12331.diff"
		eapply "${FILESDIR}/0.1653/12344.diff"
		eapply "${FILESDIR}/0.1653/12345.diff"
		eapply "${FILESDIR}/0.1653/12349.diff"
		eapply "${FILESDIR}/0.1653/12358.diff"
		eapply "${FILESDIR}/0.1653/12359.diff"
		eapply "${FILESDIR}/0.1653/4042.diff"
	fi
