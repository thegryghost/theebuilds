...
TZDB_TO_NX_SHA="34df65eff295c2bd9ee9e6a077d662486d5cabb3"
...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1474/10086.diff"
		eapply "${FILESDIR}/0.1474/10389.diff"
		eapply "${FILESDIR}/0.1474/10457.diff"
		eapply "${FILESDIR}/0.1474/10473.diff"
		eapply "${FILESDIR}/0.1474/10777.diff"
		eapply "${FILESDIR}/0.1474/10818.diff"
		eapply "${FILESDIR}/0.1474/10835.diff"
		eapply "${FILESDIR}/0.1474/10840.diff"
		eapply "${FILESDIR}/0.1474/4042.diff"
	fi
