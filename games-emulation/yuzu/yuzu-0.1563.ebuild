...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1563/10519.diff"
		eapply "${FILESDIR}/0.1563/11165.diff"
		eapply "${FILESDIR}/0.1563/11225.diff"
		eapply "${FILESDIR}/0.1563/11402.diff"
		eapply "${FILESDIR}/0.1563/4042.diff"
	fi
