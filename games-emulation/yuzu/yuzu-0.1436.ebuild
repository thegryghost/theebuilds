...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1436/10086.diff"
		eapply "${FILESDIR}/0.1436/10091.diff"
		eapply "${FILESDIR}/0.1436/10107.diff"
		eapply "${FILESDIR}/0.1436/10217.diff"
		eapply "${FILESDIR}/0.1436/4042.diff"
	fi
