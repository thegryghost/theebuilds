...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1540/10048.diff"
		eapply "${FILESDIR}/0.1540/10519.diff"
		eapply "${FILESDIR}/0.1540/11112.diff"
		eapply "${FILESDIR}/0.1540/11225.diff"
		eapply "${FILESDIR}/0.1540/11381.diff"
		eapply "${FILESDIR}/0.1540/11383.diff"
		eapply "${FILESDIR}/0.1540/11384.diff"
		eapply "${FILESDIR}/0.1540/11385.diff"
		eapply "${FILESDIR}/0.1540/11390.diff"
		eapply "${FILESDIR}/0.1540/11393.diff"
		eapply "${FILESDIR}/0.1540/11399.diff"
		eapply "${FILESDIR}/0.1540/11402.diff"
		eapply "${FILESDIR}/0.1540/11408.diff"
		eapply "${FILESDIR}/0.1540/4042.diff"
	fi
