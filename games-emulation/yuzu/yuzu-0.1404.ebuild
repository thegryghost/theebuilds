...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1404/10048.diff"
		eapply "${FILESDIR}/0.1404/10051.diff"
		eapply "${FILESDIR}/0.1404/10053.diff"
		eapply "${FILESDIR}/0.1404/10056.diff"
		eapply "${FILESDIR}/0.1404/10057.diff"
		eapply "${FILESDIR}/0.1404/4042.diff"
	fi
