...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1642/11623.diff"
		eapply "${FILESDIR}/0.1642/12173.diff"
		eapply "${FILESDIR}/0.1642/12208.diff"
		eapply "${FILESDIR}/0.1642/12236.diff"
		eapply "${FILESDIR}/0.1642/12274.diff"
		eapply "${FILESDIR}/0.1642/4042.diff"
	fi
