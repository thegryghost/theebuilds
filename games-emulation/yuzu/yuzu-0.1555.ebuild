...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1555/10519.diff"
		eapply "${FILESDIR}/0.1555/11225.diff"
		eapply "${FILESDIR}/0.1555/11385.diff"
		eapply "${FILESDIR}/0.1555/11402.diff"
		eapply "${FILESDIR}/0.1555/11435.diff"
		eapply "${FILESDIR}/0.1555/11459.diff"
		eapply "${FILESDIR}/0.1555/11473.diff"
		eapply "${FILESDIR}/0.1555/4042.diff"
	fi
