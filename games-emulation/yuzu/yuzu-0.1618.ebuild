...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1618/11535.diff"
		eapply "${FILESDIR}/0.1618/11792.diff"
		eapply "${FILESDIR}/0.1618/11990.diff"
		eapply "${FILESDIR}/0.1618/11995.diff"
		eapply "${FILESDIR}/0.1618/4042.diff"
	fi
