...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1628/11535.diff"
		eapply "${FILESDIR}/0.1628/11623.diff"
		eapply "${FILESDIR}/0.1628/11889.diff"
		eapply "${FILESDIR}/0.1628/12076.diff"
		eapply "${FILESDIR}/0.1628/12098.diff"
		eapply "${FILESDIR}/0.1628/4042.diff"
	fi
