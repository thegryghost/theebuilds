...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1597/11535.diff"
		eapply "${FILESDIR}/0.1597/11689.diff"
		eapply "${FILESDIR}/0.1597/11827.diff"
		eapply "${FILESDIR}/0.1597/11843.diff"
		eapply "${FILESDIR}/0.1597/11847.diff"
		eapply "${FILESDIR}/0.1597/4042.diff"
	fi
