...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1707/12173.diff"
		eapply "${FILESDIR}/0.1707/12461.diff"
		eapply "${FILESDIR}/0.1707/12749.diff"
		eapply "${FILESDIR}/0.1707/12756.diff"
		eapply "${FILESDIR}/0.1707/12927.diff"
		eapply "${FILESDIR}/0.1707/12949.diff"
		eapply "${FILESDIR}/0.1707/12951.diff"
		eapply "${FILESDIR}/0.1707/12955.diff"
		eapply "${FILESDIR}/0.1707/4042.diff"
	fi
