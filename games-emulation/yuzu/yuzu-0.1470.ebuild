...
VCPKG_SHA="a487471068f4cb1cbb4eeb340763cdcc0a75fd68"
...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1470/10086.diff"
		eapply "${FILESDIR}/0.1470/10389.diff"
		eapply "${FILESDIR}/0.1470/10457.diff"
		eapply "${FILESDIR}/0.1470/10486.diff"
		eapply "${FILESDIR}/0.1470/10731.diff"
		eapply "${FILESDIR}/0.1470/10739.diff"
		eapply "${FILESDIR}/0.1470/10744.diff"
		eapply "${FILESDIR}/0.1470/10775.diff"
		eapply "${FILESDIR}/0.1470/10783.diff"
		eapply "${FILESDIR}/0.1470/4042.diff"
	fi
