...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1556/10519.diff"
		eapply "${FILESDIR}/0.1556/11225.diff"
		eapply "${FILESDIR}/0.1556/11402.diff"
		eapply "${FILESDIR}/0.1556/11473.diff"
		eapply "${FILESDIR}/0.1556/11480.diff"
		eapply "${FILESDIR}/0.1556/11483.diff"
		eapply "${FILESDIR}/0.1556/4042.diff"
	fi
