...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1714/10529.diff"
		eapply "${FILESDIR}/0.1714/12173.diff"
		eapply "${FILESDIR}/0.1714/12461.diff"
		eapply "${FILESDIR}/0.1714/12749.diff"
		eapply "${FILESDIR}/0.1714/12873.diff"
		eapply "${FILESDIR}/0.1714/12993.diff"
		eapply "${FILESDIR}/0.1714/12996.diff"
		eapply "${FILESDIR}/0.1714/13000.diff"
		eapply "${FILESDIR}/0.1714/13001.diff"
		eapply "${FILESDIR}/0.1714/4042.diff"
	fi
