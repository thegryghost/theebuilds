...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1426/10086.diff"
		eapply "${FILESDIR}/0.1426/10091.diff"
		eapply "${FILESDIR}/0.1426/10132.diff"
		eapply "${FILESDIR}/0.1426/10207.diff"
		eapply "${FILESDIR}/0.1426/4042.diff"
	fi
