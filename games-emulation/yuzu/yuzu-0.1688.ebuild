...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1688/12173.diff"
		eapply "${FILESDIR}/0.1688/12499.diff"
		eapply "${FILESDIR}/0.1688/12579.diff"
		eapply "${FILESDIR}/0.1688/12660.diff"
		eapply "${FILESDIR}/0.1688/12688.diff"
		eapply "${FILESDIR}/0.1688/12701.diff"
		eapply "${FILESDIR}/0.1688/4042.diff"
	fi
