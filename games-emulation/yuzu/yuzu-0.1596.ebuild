...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1596/11535.diff"
		eapply "${FILESDIR}/0.1596/11689.diff"
		eapply "${FILESDIR}/0.1596/11789.diff"
		eapply "${FILESDIR}/0.1596/11827.diff"
		eapply "${FILESDIR}/0.1596/4042.diff"
	fi
