...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1708/12173.diff"
		eapply "${FILESDIR}/0.1708/12461.diff"
		eapply "${FILESDIR}/0.1708/12749.diff"
		eapply "${FILESDIR}/0.1708/12756.diff"
		eapply "${FILESDIR}/0.1708/12927.diff"
		eapply "${FILESDIR}/0.1708/12949.diff"
		eapply "${FILESDIR}/0.1708/12951.diff"
		eapply "${FILESDIR}/0.1708/12955.diff"
		eapply "${FILESDIR}/0.1708/12966.diff"
		eapply "${FILESDIR}/0.1708/4042.diff"
	fi
