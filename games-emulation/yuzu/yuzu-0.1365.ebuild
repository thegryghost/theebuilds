...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1365/4042.diff"
		eapply "${FILESDIR}/0.1365/9913.diff"
		eapply "${FILESDIR}/0.1365/9917.diff"
		eapply "${FILESDIR}/0.1365/9923.diff"
		eapply "${FILESDIR}/0.1365/9925.diff"
		eapply "${FILESDIR}/0.1365/9928.diff"
	fi
