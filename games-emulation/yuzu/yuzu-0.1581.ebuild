...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1581/10519.diff"
		eapply "${FILESDIR}/0.1581/11534.diff"
		eapply "${FILESDIR}/0.1581/11535.diff"
		eapply "${FILESDIR}/0.1581/11650.diff"
		eapply "${FILESDIR}/0.1581/11683.diff"
		eapply "${FILESDIR}/0.1581/11686.diff"
		eapply "${FILESDIR}/0.1581/11690.diff"
		eapply "${FILESDIR}/0.1581/11705.diff"
		eapply "${FILESDIR}/0.1581/4042.diff"
	fi
