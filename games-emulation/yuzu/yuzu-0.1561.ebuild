...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1561/10519.diff"
		eapply "${FILESDIR}/0.1561/11225.diff"
		eapply "${FILESDIR}/0.1561/11258.diff"
		eapply "${FILESDIR}/0.1561/11402.diff"
		eapply "${FILESDIR}/0.1561/11460.diff"
		eapply "${FILESDIR}/0.1561/11520.diff"
		eapply "${FILESDIR}/0.1561/11522.diff"
		eapply "${FILESDIR}/0.1561/4042.diff"
	fi
