...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1666/12173.diff"
		eapply "${FILESDIR}/0.1666/12437.diff"
		eapply "${FILESDIR}/0.1666/12452.diff"
		eapply "${FILESDIR}/0.1666/12454.diff"
		eapply "${FILESDIR}/0.1666/12466.diff"
		eapply "${FILESDIR}/0.1666/12479.diff"
		eapply "${FILESDIR}/0.1666/12487.diff"
		eapply "${FILESDIR}/0.1666/4042.diff"
	fi
