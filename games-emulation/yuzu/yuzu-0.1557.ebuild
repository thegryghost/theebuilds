...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1557/10519.diff"
		eapply "${FILESDIR}/0.1557/11225.diff"
		eapply "${FILESDIR}/0.1557/11402.diff"
		eapply "${FILESDIR}/0.1557/11479.diff"
		eapply "${FILESDIR}/0.1557/11483.diff"
		eapply "${FILESDIR}/0.1557/4042.diff"
	fi
