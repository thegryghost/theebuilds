...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1564/10519.diff"
		eapply "${FILESDIR}/0.1564/11165.diff"
		eapply "${FILESDIR}/0.1564/11225.diff"
		eapply "${FILESDIR}/0.1564/11402.diff"
		eapply "${FILESDIR}/0.1564/4042.diff"
	fi
