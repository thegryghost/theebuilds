...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1732/12461.diff"
		eapply "${FILESDIR}/0.1732/13018.diff"
		eapply "${FILESDIR}/0.1732/13174.diff"
		eapply "${FILESDIR}/0.1732/13177.diff"
		eapply "${FILESDIR}/0.1732/13178.diff"
		eapply "${FILESDIR}/0.1732/13184.diff"
		eapply "${FILESDIR}/0.1732/4042.diff"
	fi
