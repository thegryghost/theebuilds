...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1466/10086.diff"
		eapply "${FILESDIR}/0.1466/10389.diff"
		eapply "${FILESDIR}/0.1466/10457.diff"
		eapply "${FILESDIR}/0.1466/10486.diff"
		eapply "${FILESDIR}/0.1466/10603.diff"
		eapply "${FILESDIR}/0.1466/10675.diff"
		eapply "${FILESDIR}/0.1466/10693.diff"
		eapply "${FILESDIR}/0.1466/10699.diff"
		eapply "${FILESDIR}/0.1466/4042.diff"
	fi
