...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1566/10519.diff"
		eapply "${FILESDIR}/0.1566/11165.diff"
		eapply "${FILESDIR}/0.1566/11225.diff"
		eapply "${FILESDIR}/0.1566/11402.diff"
		eapply "${FILESDIR}/0.1566/11567.diff"
		eapply "${FILESDIR}/0.1566/4042.diff"
	fi
