...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1720/10529.diff"
		eapply "${FILESDIR}/0.1720/12173.diff"
		eapply "${FILESDIR}/0.1720/12461.diff"
		eapply "${FILESDIR}/0.1720/12749.diff"
		eapply "${FILESDIR}/0.1720/12873.diff"
		eapply "${FILESDIR}/0.1720/13000.diff"
		eapply "${FILESDIR}/0.1720/13001.diff"
		eapply "${FILESDIR}/0.1720/13031.diff"
		eapply "${FILESDIR}/0.1720/4042.diff"
	fi
