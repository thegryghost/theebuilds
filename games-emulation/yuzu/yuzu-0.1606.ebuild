...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1606/11535.diff"
		eapply "${FILESDIR}/0.1606/11881.diff"
		eapply "${FILESDIR}/0.1606/11885.diff"
		eapply "${FILESDIR}/0.1606/11894.diff"
		eapply "${FILESDIR}/0.1606/11896.diff"
		eapply "${FILESDIR}/0.1606/4042.diff"
	fi
