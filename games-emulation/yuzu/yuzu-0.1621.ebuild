...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1621/11535.diff"
		eapply "${FILESDIR}/0.1621/11623.diff"
		eapply "${FILESDIR}/0.1621/11792.diff"
		eapply "${FILESDIR}/0.1621/11912.diff"
		eapply "${FILESDIR}/0.1621/11917.diff"
		eapply "${FILESDIR}/0.1621/11995.diff"
		eapply "${FILESDIR}/0.1621/12007.diff"
		eapply "${FILESDIR}/0.1621/4042.diff"
	fi
