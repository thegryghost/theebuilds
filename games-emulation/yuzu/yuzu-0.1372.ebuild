...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1372/4042.diff"
		eapply "${FILESDIR}/0.1372/9778.diff"
		eapply "${FILESDIR}/0.1372/9931.diff"
		eapply "${FILESDIR}/0.1372/9938.diff"
		eapply "${FILESDIR}/0.1372/9953.diff"
		eapply "${FILESDIR}/0.1372/9955.diff"
	fi
