...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1369/4042.diff"
		eapply "${FILESDIR}/0.1369/9931.diff"
		eapply "${FILESDIR}/0.1369/9938.diff"
		eapply "${FILESDIR}/0.1369/9939.diff"
		eapply "${FILESDIR}/0.1369/9941.diff"
		eapply "${FILESDIR}/0.1369/9943.diff"
	fi
