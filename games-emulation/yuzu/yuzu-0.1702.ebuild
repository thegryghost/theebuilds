...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1702/12173.diff"
		eapply "${FILESDIR}/0.1702/12461.diff"
		eapply "${FILESDIR}/0.1702/12749.diff"
		eapply "${FILESDIR}/0.1702/12756.diff"
		eapply "${FILESDIR}/0.1702/12883.diff"
		eapply "${FILESDIR}/0.1702/12892.diff"
		eapply "${FILESDIR}/0.1702/4042.diff"
	fi
