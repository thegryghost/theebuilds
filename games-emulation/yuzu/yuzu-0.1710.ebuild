...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1710/12173.diff"
		eapply "${FILESDIR}/0.1710/12461.diff"
		eapply "${FILESDIR}/0.1710/12749.diff"
		eapply "${FILESDIR}/0.1710/12756.diff"
		eapply "${FILESDIR}/0.1710/12873.diff"
		eapply "${FILESDIR}/0.1710/12978.diff"
		eapply "${FILESDIR}/0.1710/12980.diff"
		eapply "${FILESDIR}/0.1710/4042.diff"
	fi
