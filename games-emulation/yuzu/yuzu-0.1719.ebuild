...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1719/10529.diff"
		eapply "${FILESDIR}/0.1719/12173.diff"
		eapply "${FILESDIR}/0.1719/12461.diff"
		eapply "${FILESDIR}/0.1719/12749.diff"
		eapply "${FILESDIR}/0.1719/12873.diff"
		eapply "${FILESDIR}/0.1719/13000.diff"
		eapply "${FILESDIR}/0.1719/13006.diff"
		eapply "${FILESDIR}/0.1719/13026.diff"
		eapply "${FILESDIR}/0.1719/13030.diff"
		eapply "${FILESDIR}/0.1719/13035.diff"
		eapply "${FILESDIR}/0.1719/13048.diff"
		eapply "${FILESDIR}/0.1719/4042.diff"
	fi
