...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1648/11623.diff"
		eapply "${FILESDIR}/0.1648/12173.diff"
		eapply "${FILESDIR}/0.1648/12184.diff"
		eapply "${FILESDIR}/0.1648/12304.diff"
		eapply "${FILESDIR}/0.1648/12328.diff"
		eapply "${FILESDIR}/0.1648/12331.diff"
		eapply "${FILESDIR}/0.1648/12333.diff"
		eapply "${FILESDIR}/0.1648/4042.diff"
	fi
