...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1703/12173.diff"
		eapply "${FILESDIR}/0.1703/12461.diff"
		eapply "${FILESDIR}/0.1703/12749.diff"
		eapply "${FILESDIR}/0.1703/12756.diff"
		eapply "${FILESDIR}/0.1703/12883.diff"
		eapply "${FILESDIR}/0.1703/12905.diff"
		eapply "${FILESDIR}/0.1703/4042.diff"
	fi
