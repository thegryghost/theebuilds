...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1395/10008.diff"
		eapply "${FILESDIR}/0.1395/10009.diff"
		eapply "${FILESDIR}/0.1395/10014.diff"
		eapply "${FILESDIR}/0.1395/10027.diff"
		eapply "${FILESDIR}/0.1395/10030.diff"
		eapply "${FILESDIR}/0.1395/4042.diff"
	fi
