...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1611/11535.diff"
		eapply "${FILESDIR}/0.1611/11873.diff"
		eapply "${FILESDIR}/0.1611/11894.diff"
		eapply "${FILESDIR}/0.1611/11896.diff"
		eapply "${FILESDIR}/0.1611/11912.diff"
		eapply "${FILESDIR}/0.1611/11914.diff"
		eapply "${FILESDIR}/0.1611/11917.diff"
		eapply "${FILESDIR}/0.1611/11957.diff"
		eapply "${FILESDIR}/0.1611/11961.diff"
		eapply "${FILESDIR}/0.1611/4042.diff"
	fi
