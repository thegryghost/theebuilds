...
VCPKG_SHA="656fcc6ab2b05c6d999b7eaca717027ac3738f71"
...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1467/10086.diff"
		eapply "${FILESDIR}/0.1467/10389.diff"
		eapply "${FILESDIR}/0.1467/10457.diff"
		eapply "${FILESDIR}/0.1467/10486.diff"
		eapply "${FILESDIR}/0.1467/10603.diff"
		eapply "${FILESDIR}/0.1467/10675.diff"
		eapply "${FILESDIR}/0.1467/10729.diff"
		eapply "${FILESDIR}/0.1467/10731.diff"
		eapply "${FILESDIR}/0.1467/4042.diff"
	fi
