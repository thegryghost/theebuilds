...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1442/10086.diff"
		eapply "${FILESDIR}/0.1442/10091.diff"
		eapply "${FILESDIR}/0.1442/10221.diff"
		eapply "${FILESDIR}/0.1442/10352.diff"
		eapply "${FILESDIR}/0.1442/10396.diff"
		eapply "${FILESDIR}/0.1442/10397.diff"
		eapply "${FILESDIR}/0.1442/10414.diff"
		eapply "${FILESDIR}/0.1442/10418.diff"
		eapply "${FILESDIR}/0.1442/10433.diff"
		eapply "${FILESDIR}/0.1442/10435.diff"
		eapply "${FILESDIR}/0.1442/10443.diff"
		eapply "${FILESDIR}/0.1442/4042.diff"
	fi
