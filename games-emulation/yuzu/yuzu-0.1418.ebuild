...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1418/10086.diff"
		eapply "${FILESDIR}/0.1418/10088.diff"
		eapply "${FILESDIR}/0.1418/10117.diff"
		eapply "${FILESDIR}/0.1418/10124.diff"
		eapply "${FILESDIR}/0.1418/10125.diff"
		eapply "${FILESDIR}/0.1418/10128.diff"
		eapply "${FILESDIR}/0.1418/10145.diff"
		eapply "${FILESDIR}/0.1418/10151.diff"
		eapply "${FILESDIR}/0.1418/4042.diff"
	fi
