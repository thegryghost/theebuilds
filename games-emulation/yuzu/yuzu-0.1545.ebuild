...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1545/10519.diff"
		eapply "${FILESDIR}/0.1545/11225.diff"
		eapply "${FILESDIR}/0.1545/11383.diff"
		eapply "${FILESDIR}/0.1545/11393.diff"
		eapply "${FILESDIR}/0.1545/4042.diff"
	fi
