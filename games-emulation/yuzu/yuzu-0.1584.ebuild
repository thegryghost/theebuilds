...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1584/11144.diff"
		eapply "${FILESDIR}/0.1584/11535.diff"
		eapply "${FILESDIR}/0.1584/11653.diff"
		eapply "${FILESDIR}/0.1584/11683.diff"
		eapply "${FILESDIR}/0.1584/11734.diff"
		eapply "${FILESDIR}/0.1584/11735.diff"
		eapply "${FILESDIR}/0.1584/11739.diff"
		eapply "${FILESDIR}/0.1584/4042.diff"
	fi
