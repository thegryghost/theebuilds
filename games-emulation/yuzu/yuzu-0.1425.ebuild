...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1425/10086.diff"
		eapply "${FILESDIR}/0.1425/10091.diff"
		eapply "${FILESDIR}/0.1425/10119.diff"
		eapply "${FILESDIR}/0.1425/10132.diff"
		eapply "${FILESDIR}/0.1425/10207.diff"
		eapply "${FILESDIR}/0.1425/4042.diff"
	fi
