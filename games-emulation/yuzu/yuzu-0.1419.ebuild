...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1419/10086.diff"
		eapply "${FILESDIR}/0.1419/10125.diff"
		eapply "${FILESDIR}/0.1419/10128.diff"
		eapply "${FILESDIR}/0.1419/10142.diff"
		eapply "${FILESDIR}/0.1419/10145.diff"
		eapply "${FILESDIR}/0.1419/4042.diff"
	fi
