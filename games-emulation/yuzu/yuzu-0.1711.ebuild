...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1711/12173.diff"
		eapply "${FILESDIR}/0.1711/12461.diff"
		eapply "${FILESDIR}/0.1711/12749.diff"
		eapply "${FILESDIR}/0.1711/12756.diff"
		eapply "${FILESDIR}/0.1711/12873.diff"
		eapply "${FILESDIR}/0.1711/12941.diff"
		eapply "${FILESDIR}/0.1711/4042.diff"
	fi
