...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1409/10082.diff"
		eapply "${FILESDIR}/0.1409/10084.diff"
		eapply "${FILESDIR}/0.1409/10086.diff"
		eapply "${FILESDIR}/0.1409/10088.diff"
		eapply "${FILESDIR}/0.1409/4042.diff"
		eapply "${FILESDIR}/0.1409/9973.diff"
	fi
