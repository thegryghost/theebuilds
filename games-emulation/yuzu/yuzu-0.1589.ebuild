...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1589/11349.diff"
		eapply "${FILESDIR}/0.1589/11535.diff"
		eapply "${FILESDIR}/0.1589/11653.diff"
		eapply "${FILESDIR}/0.1589/11747.diff"
		eapply "${FILESDIR}/0.1589/11774.diff"
		eapply "${FILESDIR}/0.1589/4042.diff"
	fi
