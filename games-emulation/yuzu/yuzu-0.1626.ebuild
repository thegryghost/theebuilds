...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1626/11535.diff"
		eapply "${FILESDIR}/0.1626/11623.diff"
		eapply "${FILESDIR}/0.1626/12045.diff"
		eapply "${FILESDIR}/0.1626/12074.diff"
		eapply "${FILESDIR}/0.1626/4042.diff"
	fi
