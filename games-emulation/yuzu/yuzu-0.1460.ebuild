...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1460/10086.diff"
		eapply "${FILESDIR}/0.1460/10389.diff"
		eapply "${FILESDIR}/0.1460/10476.diff"
		eapply "${FILESDIR}/0.1460/10583.diff"
		eapply "${FILESDIR}/0.1460/10591.diff"
		eapply "${FILESDIR}/0.1460/4042.diff"
	fi
