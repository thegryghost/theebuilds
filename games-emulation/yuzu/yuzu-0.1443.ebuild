...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1443/10086.diff"
		eapply "${FILESDIR}/0.1443/10091.diff"
		eapply "${FILESDIR}/0.1443/10221.diff"
		eapply "${FILESDIR}/0.1443/10352.diff"
		eapply "${FILESDIR}/0.1443/10396.diff"
		eapply "${FILESDIR}/0.1443/10397.diff"
		eapply "${FILESDIR}/0.1443/10414.diff"
		eapply "${FILESDIR}/0.1443/10418.diff"
		eapply "${FILESDIR}/0.1443/10433.diff"
		eapply "${FILESDIR}/0.1443/10435.diff"
		eapply "${FILESDIR}/0.1443/4042.diff"
	fi
