...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1463/10086.diff"
		eapply "${FILESDIR}/0.1463/10389.diff"
		eapply "${FILESDIR}/0.1463/10486.diff"
		eapply "${FILESDIR}/0.1463/10603.diff"
		eapply "${FILESDIR}/0.1463/10668.diff"
		eapply "${FILESDIR}/0.1463/10670.diff"
		eapply "${FILESDIR}/0.1463/10675.diff"
		eapply "${FILESDIR}/0.1463/10685.diff"
		eapply "${FILESDIR}/0.1463/4042.diff"
	fi
