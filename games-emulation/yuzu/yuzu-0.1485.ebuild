...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1485/10912.diff"
		eapply "${FILESDIR}/0.1485/10994.diff"
		eapply "${FILESDIR}/0.1485/10996.diff"
		eapply "${FILESDIR}/0.1485/11012.diff"
		eapply "${FILESDIR}/0.1485/4042.diff"
	fi
