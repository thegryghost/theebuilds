...
TZDB_TO_NX_SHA="8c272f21d19c6e821345fd055f41b9640f9189d0"
...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1476/10457.diff"
		eapply "${FILESDIR}/0.1476/10495.diff"
		eapply "${FILESDIR}/0.1476/10679.diff"
		eapply "${FILESDIR}/0.1476/10806.diff"
		eapply "${FILESDIR}/0.1476/10842.diff"
		eapply "${FILESDIR}/0.1476/10873.diff"
		eapply "${FILESDIR}/0.1476/4042.diff"
	fi
