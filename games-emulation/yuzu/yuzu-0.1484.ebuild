...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1484/10479.diff"
		eapply "${FILESDIR}/0.1484/10710.diff"
		eapply "${FILESDIR}/0.1484/10942.diff"
		eapply "${FILESDIR}/0.1484/10969.diff"
		eapply "${FILESDIR}/0.1484/4042.diff"
	fi
