...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1671/12173.diff"
		eapply "${FILESDIR}/0.1671/12437.diff"
		eapply "${FILESDIR}/0.1671/12549.diff"
		eapply "${FILESDIR}/0.1671/12557.diff"
		eapply "${FILESDIR}/0.1671/4042.diff"
	fi
