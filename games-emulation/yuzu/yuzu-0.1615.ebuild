...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1615/11535.diff"
		eapply "${FILESDIR}/0.1615/11912.diff"
		eapply "${FILESDIR}/0.1615/11914.diff"
		eapply "${FILESDIR}/0.1615/11917.diff"
		eapply "${FILESDIR}/0.1615/4042.diff"
	fi
