...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1659/12173.diff"
		eapply "${FILESDIR}/0.1659/12394.diff"
		eapply "${FILESDIR}/0.1659/12410.diff"
		eapply "${FILESDIR}/0.1659/12412.diff"
		eapply "${FILESDIR}/0.1659/12432.diff"
		eapply "${FILESDIR}/0.1659/12435.diff"
		eapply "${FILESDIR}/0.1659/4042.diff"
	fi
