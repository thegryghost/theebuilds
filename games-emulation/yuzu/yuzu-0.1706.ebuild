...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1706/12173.diff"
		eapply "${FILESDIR}/0.1706/12461.diff"
		eapply "${FILESDIR}/0.1706/12749.diff"
		eapply "${FILESDIR}/0.1706/12756.diff"
		eapply "${FILESDIR}/0.1706/12914.diff"
		eapply "${FILESDIR}/0.1706/12932.diff"
		eapply "${FILESDIR}/0.1706/12939.diff"
		eapply "${FILESDIR}/0.1706/4042.diff"
	fi
