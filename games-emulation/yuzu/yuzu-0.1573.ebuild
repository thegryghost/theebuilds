...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1573/10519.diff"
		eapply "${FILESDIR}/0.1573/11535.diff"
		eapply "${FILESDIR}/0.1573/11632.diff"
		eapply "${FILESDIR}/0.1573/11646.diff"
		eapply "${FILESDIR}/0.1573/4042.diff"
	fi
