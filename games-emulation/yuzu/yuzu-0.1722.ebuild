...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1722/12173.diff"
		eapply "${FILESDIR}/0.1722/12461.diff"
		eapply "${FILESDIR}/0.1722/12749.diff"
		eapply "${FILESDIR}/0.1722/12982.diff"
		eapply "${FILESDIR}/0.1722/13000.diff"
		eapply "${FILESDIR}/0.1722/13001.diff"
		eapply "${FILESDIR}/0.1722/13075.diff"
		eapply "${FILESDIR}/0.1722/13096.diff"
		eapply "${FILESDIR}/0.1722/4042.diff"
	fi
