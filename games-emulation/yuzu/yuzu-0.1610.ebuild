...
VULKAN_HEADERS_SHA="df60f0316899460eeaaefa06d2dd7e4e300c1604"
...
INIH_SHA="9cecf0643da0846e77f64d10a126d9f48b9e05e8"
...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1610/11535.diff"
		eapply "${FILESDIR}/0.1610/11873.diff"
		eapply "${FILESDIR}/0.1610/11881.diff"
		eapply "${FILESDIR}/0.1610/11885.diff"
		eapply "${FILESDIR}/0.1610/11894.diff"
		eapply "${FILESDIR}/0.1610/11896.diff"
		eapply "${FILESDIR}/0.1610/11912.diff"
		eapply "${FILESDIR}/0.1610/11914.diff"
		eapply "${FILESDIR}/0.1610/11917.diff"
		eapply "${FILESDIR}/0.1610/11952.diff"
		eapply "${FILESDIR}/0.1610/11957.diff"
		eapply "${FILESDIR}/0.1610/4042.diff"
	fi
