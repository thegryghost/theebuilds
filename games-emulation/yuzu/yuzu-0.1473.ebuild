...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1473/10086.diff"
		eapply "${FILESDIR}/0.1473/10389.diff"
		eapply "${FILESDIR}/0.1473/10457.diff"
		eapply "${FILESDIR}/0.1473/10777.diff"
		eapply "${FILESDIR}/0.1473/10818.diff"
		eapply "${FILESDIR}/0.1473/4042.diff"
	fi
