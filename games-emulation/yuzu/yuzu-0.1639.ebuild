...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1639/11623.diff"
		eapply "${FILESDIR}/0.1639/12094.diff"
		eapply "${FILESDIR}/0.1639/12173.diff"
		eapply "${FILESDIR}/0.1639/12196.diff"
		eapply "${FILESDIR}/0.1639/12235.diff"
		eapply "${FILESDIR}/0.1639/12236.diff"
		eapply "${FILESDIR}/0.1639/12263.diff"
		eapply "${FILESDIR}/0.1639/4042.diff"
	fi
