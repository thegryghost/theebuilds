...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1560/10519.diff"
		eapply "${FILESDIR}/0.1560/11225.diff"
		eapply "${FILESDIR}/0.1560/11402.diff"
		eapply "${FILESDIR}/0.1560/11460.diff"
		eapply "${FILESDIR}/0.1560/11483.diff"
		eapply "${FILESDIR}/0.1560/11492.diff"
		eapply "${FILESDIR}/0.1560/11499.diff"
		eapply "${FILESDIR}/0.1560/4042.diff"
	fi
