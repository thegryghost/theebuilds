...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1441/10086.diff"
		eapply "${FILESDIR}/0.1441/10091.diff"
		eapply "${FILESDIR}/0.1441/10221.diff"
		eapply "${FILESDIR}/0.1441/10396.diff"
		eapply "${FILESDIR}/0.1441/10397.diff"
		eapply "${FILESDIR}/0.1441/10398.diff"
		eapply "${FILESDIR}/0.1441/10417.diff"
		eapply "${FILESDIR}/0.1441/10422.diff"
		eapply "${FILESDIR}/0.1441/4042.diff"
	fi
