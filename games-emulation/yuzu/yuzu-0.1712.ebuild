...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1712/10529.diff"
		eapply "${FILESDIR}/0.1712/12461.diff"
		eapply "${FILESDIR}/0.1712/12873.diff"
		eapply "${FILESDIR}/0.1712/12941.diff"
		eapply "${FILESDIR}/0.1712/12974.diff"
		eapply "${FILESDIR}/0.1712/12975.diff"
		eapply "${FILESDIR}/0.1712/12989.diff"
		eapply "${FILESDIR}/0.1712/12993.diff"
		eapply "${FILESDIR}/0.1712/13000.diff"
		eapply "${FILESDIR}/0.1712/13001.diff"
		eapply "${FILESDIR}/0.1712/4042.diff"
	fi
