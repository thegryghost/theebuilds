...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1567/10519.diff"
		eapply "${FILESDIR}/0.1567/11225.diff"
		eapply "${FILESDIR}/0.1567/11402.diff"
		eapply "${FILESDIR}/0.1567/11493.diff"
		eapply "${FILESDIR}/0.1567/4042.diff"
	fi
