...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1664/12173.diff"
		eapply "${FILESDIR}/0.1664/12452.diff"
		eapply "${FILESDIR}/0.1664/12454.diff"
		eapply "${FILESDIR}/0.1664/12466.diff"
		eapply "${FILESDIR}/0.1664/12479.diff"
		eapply "${FILESDIR}/0.1664/12487.diff"
		eapply "${FILESDIR}/0.1664/4042.diff"
	fi
