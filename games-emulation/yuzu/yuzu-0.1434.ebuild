...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1434/10086.diff"
		eapply "${FILESDIR}/0.1434/10091.diff"
		eapply "${FILESDIR}/0.1434/10107.diff"
		eapply "${FILESDIR}/0.1434/10254.diff"
		eapply "${FILESDIR}/0.1434/10265.diff"
		eapply "${FILESDIR}/0.1434/10302.diff"
		eapply "${FILESDIR}/0.1434/4042.diff"
	fi
