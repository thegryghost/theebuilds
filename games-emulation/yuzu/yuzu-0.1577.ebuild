...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1577/10519.diff"
		eapply "${FILESDIR}/0.1577/11534.diff"
		eapply "${FILESDIR}/0.1577/11535.diff"
		eapply "${FILESDIR}/0.1577/11639.diff"
		eapply "${FILESDIR}/0.1577/11648.diff"
		eapply "${FILESDIR}/0.1577/11650.diff"
		eapply "${FILESDIR}/0.1577/11669.diff"
		eapply "${FILESDIR}/0.1577/11677.diff"
		eapply "${FILESDIR}/0.1577/4042.diff"
	fi
