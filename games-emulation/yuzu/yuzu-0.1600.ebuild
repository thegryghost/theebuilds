...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1600/11535.diff"
		eapply "${FILESDIR}/0.1600/11689.diff"
		eapply "${FILESDIR}/0.1600/11827.diff"
		eapply "${FILESDIR}/0.1600/11843.diff"
		eapply "${FILESDIR}/0.1600/11852.diff"
		eapply "${FILESDIR}/0.1600/11859.diff"
		eapply "${FILESDIR}/0.1600/11862.diff"
		eapply "${FILESDIR}/0.1600/11876.diff"
		eapply "${FILESDIR}/0.1600/4042.diff"
	fi
