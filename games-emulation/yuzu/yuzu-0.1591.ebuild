...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1591/11349.diff"
		eapply "${FILESDIR}/0.1591/11535.diff"
		eapply "${FILESDIR}/0.1591/11689.diff"
		eapply "${FILESDIR}/0.1591/11747.diff"
		eapply "${FILESDIR}/0.1591/11748.diff"
		eapply "${FILESDIR}/0.1591/11774.diff"
		eapply "${FILESDIR}/0.1591/11791.diff"
		eapply "${FILESDIR}/0.1591/11795.diff"
		eapply "${FILESDIR}/0.1591/4042.diff"
	fi
