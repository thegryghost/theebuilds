...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1468/10086.diff"
		eapply "${FILESDIR}/0.1468/10389.diff"
		eapply "${FILESDIR}/0.1468/10457.diff"
		eapply "${FILESDIR}/0.1468/10486.diff"
		eapply "${FILESDIR}/0.1468/10603.diff"
		eapply "${FILESDIR}/0.1468/10731.diff"
		eapply "${FILESDIR}/0.1468/4042.diff"
	fi
