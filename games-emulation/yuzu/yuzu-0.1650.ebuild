...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1650/11623.diff"
		eapply "${FILESDIR}/0.1650/12173.diff"
		eapply "${FILESDIR}/0.1650/12184.diff"
		eapply "${FILESDIR}/0.1650/12290.diff"
		eapply "${FILESDIR}/0.1650/12304.diff"
		eapply "${FILESDIR}/0.1650/12331.diff"
		eapply "${FILESDIR}/0.1650/12345.diff"
		eapply "${FILESDIR}/0.1650/12349.diff"
		eapply "${FILESDIR}/0.1650/4042.diff"
	fi
