...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1562/10519.diff"
		eapply "${FILESDIR}/0.1562/11225.diff"
		eapply "${FILESDIR}/0.1562/11402.diff"
		eapply "${FILESDIR}/0.1562/11526.diff"
		eapply "${FILESDIR}/0.1562/4042.diff"
	fi
