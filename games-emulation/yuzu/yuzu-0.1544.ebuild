...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1544/10519.diff"
		eapply "${FILESDIR}/0.1544/11225.diff"
		eapply "${FILESDIR}/0.1544/11383.diff"
		eapply "${FILESDIR}/0.1544/11393.diff"
		eapply "${FILESDIR}/0.1544/4042.diff"
	fi
