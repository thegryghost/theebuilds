...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1608/11535.diff"
		eapply "${FILESDIR}/0.1608/11873.diff"
		eapply "${FILESDIR}/0.1608/11894.diff"
		eapply "${FILESDIR}/0.1608/11896.diff"
		eapply "${FILESDIR}/0.1608/11936.diff"
		eapply "${FILESDIR}/0.1608/4042.diff"
	fi
