...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1721/10529.diff"
		eapply "${FILESDIR}/0.1721/12173.diff"
		eapply "${FILESDIR}/0.1721/12461.diff"
		eapply "${FILESDIR}/0.1721/12749.diff"
		eapply "${FILESDIR}/0.1721/12982.diff"
		eapply "${FILESDIR}/0.1721/13000.diff"
		eapply "${FILESDIR}/0.1721/13001.diff"
		eapply "${FILESDIR}/0.1721/13079.diff"
		eapply "${FILESDIR}/0.1721/4042.diff"
	fi
