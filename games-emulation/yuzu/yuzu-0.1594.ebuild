...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1594/11535.diff"
		eapply "${FILESDIR}/0.1594/11689.diff"
		eapply "${FILESDIR}/0.1594/11748.diff"
		eapply "${FILESDIR}/0.1594/11789.diff"
		eapply "${FILESDIR}/0.1594/11806.diff"
		eapply "${FILESDIR}/0.1594/11825.diff"
		eapply "${FILESDIR}/0.1594/4042.diff"
	fi
