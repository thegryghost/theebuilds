...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1640/11623.diff"
		eapply "${FILESDIR}/0.1640/12094.diff"
		eapply "${FILESDIR}/0.1640/12173.diff"
		eapply "${FILESDIR}/0.1640/12196.diff"
		eapply "${FILESDIR}/0.1640/12235.diff"
		eapply "${FILESDIR}/0.1640/12236.diff"
		eapply "${FILESDIR}/0.1640/12263.diff"
		eapply "${FILESDIR}/0.1640/4042.diff"
	fi
