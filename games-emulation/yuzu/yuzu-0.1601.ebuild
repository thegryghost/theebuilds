...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1601/11535.diff"
		eapply "${FILESDIR}/0.1601/11689.diff"
		eapply "${FILESDIR}/0.1601/11728.diff"
		eapply "${FILESDIR}/0.1601/11792.diff"
		eapply "${FILESDIR}/0.1601/11827.diff"
		eapply "${FILESDIR}/0.1601/11843.diff"
		eapply "${FILESDIR}/0.1601/11852.diff"
		eapply "${FILESDIR}/0.1601/11859.diff"
		eapply "${FILESDIR}/0.1601/11862.diff"
		eapply "${FILESDIR}/0.1601/11866.diff"
		eapply "${FILESDIR}/0.1601/4042.diff"
	fi
