...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1619/11535.diff"
		eapply "${FILESDIR}/0.1619/11623.diff"
		eapply "${FILESDIR}/0.1619/11792.diff"
		eapply "${FILESDIR}/0.1619/11912.diff"
		eapply "${FILESDIR}/0.1619/11917.diff"
		eapply "${FILESDIR}/0.1619/11995.diff"
		eapply "${FILESDIR}/0.1619/12019.diff"
		eapply "${FILESDIR}/0.1619/4042.diff"
	fi
