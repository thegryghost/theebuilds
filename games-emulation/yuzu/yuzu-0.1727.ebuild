...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1727/12461.diff"
		eapply "${FILESDIR}/0.1727/13018.diff"
		eapply "${FILESDIR}/0.1727/13135.diff"
		eapply "${FILESDIR}/0.1727/13171.diff"
		eapply "${FILESDIR}/0.1727/13172.diff"
		eapply "${FILESDIR}/0.1727/4042.diff"
	fi
