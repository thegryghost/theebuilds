...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1629/11535.diff"
		eapply "${FILESDIR}/0.1629/11623.diff"
		eapply "${FILESDIR}/0.1629/11889.diff"
		eapply "${FILESDIR}/0.1629/12076.diff"
		eapply "${FILESDIR}/0.1629/12098.diff"
		eapply "${FILESDIR}/0.1629/4042.diff"
	fi
