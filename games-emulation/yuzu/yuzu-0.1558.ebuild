...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1558/10519.diff"
		eapply "${FILESDIR}/0.1558/11225.diff"
		eapply "${FILESDIR}/0.1558/11402.diff"
		eapply "${FILESDIR}/0.1558/11460.diff"
		eapply "${FILESDIR}/0.1558/11483.diff"
		eapply "${FILESDIR}/0.1558/11492.diff"
		eapply "${FILESDIR}/0.1558/4042.diff"
	fi
