...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1378/4042.diff"
		eapply "${FILESDIR}/0.1378/9962.diff"
		eapply "${FILESDIR}/0.1378/9964.diff"
		eapply "${FILESDIR}/0.1378/9971.diff"
		eapply "${FILESDIR}/0.1378/9975.diff"
	fi
