...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1428/10086.diff"
		eapply "${FILESDIR}/0.1428/10091.diff"
		eapply "${FILESDIR}/0.1428/10107.diff"
		eapply "${FILESDIR}/0.1428/10181.diff"
		eapply "${FILESDIR}/0.1428/10221.diff"
		eapply "${FILESDIR}/0.1428/10234.diff"
		eapply "${FILESDIR}/0.1428/10236.diff"
		eapply "${FILESDIR}/0.1428/10237.diff"
		eapply "${FILESDIR}/0.1428/4042.diff"
	fi
