...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1617/11535.diff"
		eapply "${FILESDIR}/0.1617/11792.diff"
		eapply "${FILESDIR}/0.1617/11912.diff"
		eapply "${FILESDIR}/0.1617/11917.diff"
		eapply "${FILESDIR}/0.1617/11980.diff"
		eapply "${FILESDIR}/0.1617/11990.diff"
		eapply "${FILESDIR}/0.1617/11995.diff"
		eapply "${FILESDIR}/0.1617/4042.diff"
	fi
