...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1574/10519.diff"
		eapply "${FILESDIR}/0.1574/11535.diff"
		eapply "${FILESDIR}/0.1574/11632.diff"
		eapply "${FILESDIR}/0.1574/11646.diff"
		eapply "${FILESDIR}/0.1574/4042.diff"
	fi
