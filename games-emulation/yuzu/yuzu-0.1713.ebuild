...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1713/10529.diff"
		eapply "${FILESDIR}/0.1713/12461.diff"
		eapply "${FILESDIR}/0.1713/12873.diff"
		eapply "${FILESDIR}/0.1713/12996.diff"
		eapply "${FILESDIR}/0.1713/13001.diff"
		eapply "${FILESDIR}/0.1713/4042.diff"
	fi
