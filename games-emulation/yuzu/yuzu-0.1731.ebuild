...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1731/12461.diff"
		eapply "${FILESDIR}/0.1731/13018.diff"
		eapply "${FILESDIR}/0.1731/13174.diff"
		eapply "${FILESDIR}/0.1731/13177.diff"
		eapply "${FILESDIR}/0.1731/13178.diff"
		eapply "${FILESDIR}/0.1731/13184.diff"
		eapply "${FILESDIR}/0.1731/4042.diff"
	fi
