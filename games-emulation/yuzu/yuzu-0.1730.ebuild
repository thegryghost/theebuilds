...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1730/12461.diff"
		eapply "${FILESDIR}/0.1730/13018.diff"
		eapply "${FILESDIR}/0.1730/13174.diff"
		eapply "${FILESDIR}/0.1730/13177.diff"
		eapply "${FILESDIR}/0.1730/13178.diff"
		eapply "${FILESDIR}/0.1730/13184.diff"
		eapply "${FILESDIR}/0.1730/4042.diff"
	fi
