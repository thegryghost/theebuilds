...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1604/11535.diff"
		eapply "${FILESDIR}/0.1604/11689.diff"
		eapply "${FILESDIR}/0.1604/11728.diff"
		eapply "${FILESDIR}/0.1604/11827.diff"
		eapply "${FILESDIR}/0.1604/11843.diff"
		eapply "${FILESDIR}/0.1604/11852.diff"
		eapply "${FILESDIR}/0.1604/11859.diff"
		eapply "${FILESDIR}/0.1604/11862.diff"
		eapply "${FILESDIR}/0.1604/11866.diff"
		eapply "${FILESDIR}/0.1604/4042.diff"
	fi
