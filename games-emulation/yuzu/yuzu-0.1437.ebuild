...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1437/10086.diff"
		eapply "${FILESDIR}/0.1437/10091.diff"
		eapply "${FILESDIR}/0.1437/10262.diff"
		eapply "${FILESDIR}/0.1437/10344.diff"
		eapply "${FILESDIR}/0.1437/4042.diff"
	fi
