...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1667/12173.diff"
		eapply "${FILESDIR}/0.1667/12437.diff"
		eapply "${FILESDIR}/0.1667/12452.diff"
		eapply "${FILESDIR}/0.1667/12454.diff"
		eapply "${FILESDIR}/0.1667/12466.diff"
		eapply "${FILESDIR}/0.1667/12499.diff"
		eapply "${FILESDIR}/0.1667/4042.diff"
	fi
