...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1598/11535.diff"
		eapply "${FILESDIR}/0.1598/11689.diff"
		eapply "${FILESDIR}/0.1598/11827.diff"
		eapply "${FILESDIR}/0.1598/11843.diff"
		eapply "${FILESDIR}/0.1598/11846.diff"
		eapply "${FILESDIR}/0.1598/11847.diff"
		eapply "${FILESDIR}/0.1598/11854.diff"
		eapply "${FILESDIR}/0.1598/4042.diff"
	fi
