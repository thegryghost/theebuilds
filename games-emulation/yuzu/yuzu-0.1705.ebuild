...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1705/12173.diff"
		eapply "${FILESDIR}/0.1705/12461.diff"
		eapply "${FILESDIR}/0.1705/12749.diff"
		eapply "${FILESDIR}/0.1705/12756.diff"
		eapply "${FILESDIR}/0.1705/12883.diff"
		eapply "${FILESDIR}/0.1705/12914.diff"
		eapply "${FILESDIR}/0.1705/12928.diff"
		eapply "${FILESDIR}/0.1705/12932.diff"
		eapply "${FILESDIR}/0.1705/4042.diff"
	fi
