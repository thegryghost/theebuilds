...
src_prepare() {
	...
	if use earlyaccess; then
		eapply "${FILESDIR}/0.1625/11535.diff"
		eapply "${FILESDIR}/0.1625/11623.diff"
		eapply "${FILESDIR}/0.1625/11792.diff"
		eapply "${FILESDIR}/0.1625/12045.diff"
		eapply "${FILESDIR}/0.1625/12066.diff"
		eapply "${FILESDIR}/0.1625/4042.diff"
	fi
